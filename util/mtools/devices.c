...
#ifdef __386BSD__
struct device devices[] = {
        {'A', "/dev/fd0a", 0L, 12, 0, (int (*) ()) 0, 80, 2, 18}, /* 1.44m */
        {'A', "/dev/fd0a", 0L, 12, 0, (int (*) ()) 0, 80, 2, 15}, /* 1.2m */
        {'A', "/dev/fd0a", 0L, 12, 0, (int (*) ()) 0, 80, 2, 9},  /* 720k */
        {'A', "/dev/fd0a", 0L, 12, 0, (int (*) ()) 0, 40, 2, 9},  /* 360k */
        {'A', "/dev/fd0a", 0L, 12, 0, (int (*) ()) 0, 40, 2, 8},  /* 320k */
        {'B', "/dev/fd1a", 0L, 12, 0, (int (*) ()) 0, 80, 2, 18}, /* 1.44m */
        {'B', "/dev/fd1a", 0L, 12, 0, (int (*) ()) 0, 80, 2, 15}, /* 1.2m */
        {'B', "/dev/fd1a", 0L, 12, 0, (int (*) ()) 0, 80, 2, 9},  /* 720k */
        {'B', "/dev/fd1a", 0L, 12, 0, (int (*) ()) 0, 40, 2, 9},  /* 360k */
        {'B', "/dev/fd1a", 0L, 12, 0, (int (*) ()) 0, 40, 2, 8},  /* 320k */
        {'\0', (char *) NULL, 0L, 0, 0, (int (*) ()) 0, 0, 0, 0}
};
#endif /* __386BSD__ */
