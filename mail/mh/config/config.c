...
#ifndef	lint
static char ident[] = "@(#)config.c,v 1.1.1.1 1993/01/30 04:40:00 jtc Exp";
#endif	/* lint */
...
#if	defined(__STDC__)
#define	binpath(file) "/usr/local/bin/"#file
...
static char Config[] = "@(#)Config: MH.386bsd";

char *options[] = {"BIND", "BSD42", "BSD43", "DBMPWD", "MHE", "MHRC", "MIME", "MORE='\"/usr/bin/more\"'", "NTOHLSWAP", "OVERHEAD", "POP", "POSIX", "RPOP", "SENDMTS", "SMTP", "SPRINTFTYPE=int", "SYS5DIR", "TYPESIG=void", "VSPRINTF", "WHATNOW", "ZONEINFO", NULL};
