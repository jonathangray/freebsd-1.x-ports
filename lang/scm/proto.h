...
int run_scm P((int iverbose , int argc , char **argv ));
...
void init_init P((void ));
SCM repl_driver P((void ));
SCM line_num P((void ));
...
SCM aind P((SCM ra , SCM ind , SCM args ));
...
SCM array_inbp P((SCM v , SCM ind , SCM args ));
SCM aref P((SCM v , SCM ind , SCM args ));
...
int SUBROPT P((int lleaveok , int leaveok , int s_leaveok , SUBROPT (lscrollok ,scrollok ,s_scrollok ,0 )static char s_clearok []=0 ));
