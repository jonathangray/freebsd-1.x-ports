...
/* #define MAKINUM(x) (((x)<<2)+2L)	moved to config.h
...
#define NUM_XSPCSYMS 14

#define NUM_ISYMS (NUM_XSPCSYMS+0)
...
SCM call_cc(PROTO), copytree(PROTO), eval(PROTO);
...
SCM clist2uve(PROTO), clist2array(PROTO), list2ura(PROTO);
