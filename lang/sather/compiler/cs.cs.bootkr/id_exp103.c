...
ptr ID_103_dup_();
ID_103_put_kwdname_();
ptr ID_103_sather_code_();
ptr ID_103_initialize_();
ID_103_resolve_predef_types_();
ID_103_semant_();
ptr ID_103_typeof_();
int ID_103_get_offset_();
ID_103_cprint_offset_();
ptr ID_103_get_constval_();
ID_103_cont_cprint_code_();
ID_103_cprint_cname_();
ID_103_cprint_extern_();
ID_103_cprint_access_value_();
ID_103_cprint_init_code_();
char ID_103_valid_init_expr_();
char ID_103_assignable_p_();
ptr ID_103_gen_temps_();
ptr ID_103_expr_eval_constant_();
ID_103_get_ext_strs_();
char ID_103_to_be_pre_evaluated_();
char ID_103_access_value_only_();
ID_103_fob_error_();
ID_103_cprint_pre_code_();
ID_103_cprint_act_code_();
ID_103_cprint_cast_code_();
...
ptr ID_103_create_(self__,nm__,ln__)
ptr self__;
int nm__;
int ln__;
{
...
ID_103_out_of_line_(self__,fn__)
ptr self__;
ptr fn__;
{
...
ID_103_put_kwdname_(self__,nm__)
ptr self__;
int nm__;
{
   ptr gl1231_;
...
ptr ID_103_sather_code_(self__)
ptr self__;
{
   ptr res__ = 0;
...
ptr ID_103_initialize_(self__,initarg__)
ptr self__;
ptr initarg__;
{
   ptr res__ = 0;
...
ID_103_resolve_predef_types_(self__,index__)
ptr self__;
int index__;
{
...
ID_103_semant_(self__,symtab__)
ptr self__;
ptr symtab__;
{
...
ID_103_cprint_offset_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
ptr ID_103_get_constval_(self__)
ptr self__;
{
   ptr res__ = 0;
...
ID_103_cont_cprint_code_(self__,outfile__,cont__)
ptr self__;
ptr outfile__;
int cont__;
{
...
ID_103_cprint_cname_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
ID_103_cprint_extern_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
ID_103_cprint_access_value_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
ID_103_cprint_init_code_(self__,outfile__)
ptr self__;
ptr outfile__;
{
   ptr gl1279_;
...
char ID_103_valid_init_expr_(self__)
ptr self__;
{
...
char ID_103_assignable_p_(self__)
ptr self__;
{
   char res__ = S_char_VOID_;
...
ptr ID_103_expr_eval_constant_(self__)
ptr self__;
{
   ptr res__ = 0;
...
char ID_103_to_be_pre_evaluated_(self__)
ptr self__;
{
   char res__ = S_char_VOID_;
...
char ID_103_access_value_only_(self__)
ptr self__;
{
   char res__ = S_char_VOID_;
   ptr gl1318_;
...
ID_103_fob_error_(self__,op_name__,cls_name__)
ptr self__;
ptr op_name__;
ptr cls_name__;
{
...
ID_103_cprint_pre_code_(self__,outfile__)
ptr self__;
ptr outfile__;
{
   ptr gl1321_;
...
ID_103_cprint_act_code_(self__,outfile__)
ptr self__;
ptr outfile__;
{
   SATHER_STR_(20,12,ls475_,"ID_EXPROB_S");
