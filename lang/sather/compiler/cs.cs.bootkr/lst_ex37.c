...
ptr LST37_dup_();
LST37_put_kwdname_();
ptr LST37_sather_code_();
ptr LST37_initialize_();
ptr LST37_pcopy_();
LST37_clear_();
/*constant*/ int LST37_def_init_size_ = 5;
ptr LST37_push_();
int LST37_size_();
char LST37_is_empty_();
ptr LST37_pop_();
ptr LST37_top_();
LST37_init_iterate_();
ptr LST37_curr_item_();
ptr LST37_next_item_();
ptr LST37_prev_item_();
ptr LST37_push_unique_();
ptr LST37_append_();
ptr LST37_union_();
char LST37_not_in_();
int LST37_contains_();
...
ptr LST37_create_(self__,init_size__)
ptr self__;
int init_size__;
{
   ptr res__ = 0;
...
LST37_out_of_line_(self__,fn__)
ptr self__;
ptr fn__;
{
...
LST37_put_kwdname_(self__,nm__)
ptr self__;
int nm__;
{
   ptr gl609_;
...
ptr LST37_initialize_(self__,initarg__)
ptr self__;
ptr initarg__;
{
   ptr res__ = 0;
...
ptr LST37_pcopy_(self__,pl__,pi__)
ptr self__;
ptr pl__;
ptr pi__;
{
...
ptr LST37_push_unique_(self__,e__)
ptr self__;
ptr e__;
{
   ptr res__ = 0;
...
ptr LST37_append_(self__,list__)
ptr self__;
ptr list__;
{
   ptr res__ = 0;
...
ptr LST37_union_(self__,list__)
ptr self__;
ptr list__;
{
   ptr res__ = 0;
...
int LST37_contains_(self__,e__)
ptr self__;
ptr e__;
{
   int res__ = S_int_VOID_;
