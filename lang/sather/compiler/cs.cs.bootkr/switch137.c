...
ptr SWI137_dup_();
SWI137_put_kwdname_();
ptr SWI137_sather_code_();
ptr SWI137_initialize_();
SWI137_resolve_predef_types_();
SWI137_semant_();
ptr SWI137_typeof_();
int SWI137_get_offset_();
SWI137_cprint_offset_();
ptr SWI137_get_constval_();
SWI137_cont_cprint_code_();
SWI137_cprint_cname_();
SWI137_cprint_extern_();
SWI137_cprint_access_value_();
SWI137_cprint_init_code_();
char SWI137_typechk_exprs_();
ptr SWI137_gen_temps_();
SWI137_gen_goto_tags_();
SWI137_validate_dispatches_and_get_ext_strs_();
SWI137_cprint_code_();
SWI137_cprint_if_form_code_();
SWI137_cprint_then_parts_code_();
SWI137_cprint_default_code_();
SWI137_cprint_caseform_code_();
extern int attr_ent_SWI137[];

ptr SWI137_create_(self__,t__,wp__,ep__,ln__)
ptr self__;
ptr t__;
ptr wp__;
ptr ep__;
...
SWI137_out_of_line_(self__,fn__)
ptr self__;
ptr fn__;
{
...
SWI137_put_kwdname_(self__,nm__)
ptr self__;
int nm__;
{
   ptr gl3292_;
...
ptr SWI137_sather_code_(self__)
ptr self__;
{
   ptr res__ = 0;
...
ptr SWI137_initialize_(self__,initarg__)
ptr self__;
ptr initarg__;
{
   ptr res__ = 0;
...
SWI137_resolve_predef_types_(self__,index__)
ptr self__;
int index__;
{
   ptr gl3295_;
...
SWI137_semant_(self__,symtab__)
ptr self__;
ptr symtab__;
{
...
SWI137_cprint_offset_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
ptr SWI137_get_constval_(self__)
ptr self__;
{
   ptr res__ = 0;
...
SWI137_cont_cprint_code_(self__,outfile__,cont__)
ptr self__;
ptr outfile__;
int cont__;
{
...
SWI137_cprint_cname_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
SWI137_cprint_extern_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
SWI137_cprint_access_value_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
SWI137_cprint_init_code_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
char SWI137_typechk_exprs_(self__,tp__)
ptr self__;
ptr tp__;
{
...
SWI137_gen_goto_tags_(self__,block__)
ptr self__;
ptr block__;
{
...
SWI137_validate_dispatches_and_get_ext_strs_(self__)
ptr self__;
{
   ptr gl3327_;
   static int gl3328_;
...
SWI137_cprint_code_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
SWI137_cprint_if_form_code_(self__,outfile__,i__,j__)
ptr self__;
ptr outfile__;
int i__;
int j__;
...
SWI137_cprint_default_code_(self__,outfile__,i__,j__)
ptr self__;
ptr outfile__;
int i__;
int j__;
