...
ptr LIS198_push_();
int LIS198_size_();
char LIS198_is_empty_();
ptr LIS198_pop_();
ptr LIS198_top_();
LIS198_init_iterate_();
ptr LIS198_curr_item_();
ptr LIS198_next_item_();
ptr LIS198_prev_item_();
ptr LIS198_push_unique_();
ptr LIS198_append_();
ptr LIS198_union_();
char LIS198_not_in_();
int LIS198_contains_();
ptr LIS198_initialize_();
extern int attr_ent_LIS198[];

LIS198_clear_(self__)
ptr self__;
{
   int    i__ = S_int_VOID_;
...
ptr LIS198_create_(self__,init_size__)
ptr self__;
int init_size__;
{
   ptr res__ = 0;
...
ptr LIS198_push_unique_(self__,e__)
ptr self__;
ptr e__;
{
   ptr res__ = 0;
...
ptr LIS198_append_(self__,list__)
ptr self__;
ptr list__;
{
   ptr res__ = 0;
...
ptr LIS198_union_(self__,list__)
ptr self__;
ptr list__;
{
   ptr res__ = 0;
...
char LIS198_not_in_(self__,e__)
ptr self__;
ptr e__;
{
   char res__ = S_char_VOID_;
...
int LIS198_contains_(self__,e__)
ptr self__;
ptr e__;
{
   int res__ = S_int_VOID_;
...
ptr LIS198_initialize_(self__,initarg__)
ptr self__;
ptr initarg__;
{
   ptr res__ = 0;
