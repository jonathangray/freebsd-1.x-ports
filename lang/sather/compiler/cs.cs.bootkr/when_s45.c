...
ptr WHE45_dup_();
WHE45_put_kwdname_();
ptr WHE45_sather_code_();
ptr WHE45_initialize_();
ptr WHE45_pcopy_();
extern int attr_ent_WHE45[];

ptr WHE45_create_(self__,e__,t__)
ptr self__;
ptr e__;
ptr t__;
{
...
WHE45_out_of_line_(self__,fn__)
ptr self__;
ptr fn__;
{
...
WHE45_put_kwdname_(self__,nm__)
ptr self__;
int nm__;
{
   ptr gl747_;
...
ptr WHE45_initialize_(self__,initarg__)
ptr self__;
ptr initarg__;
{
   ptr res__ = 0;
...
ptr WHE45_pcopy_(self__,pl__,pi__)
ptr self__;
ptr pl__;
ptr pi__;
{
