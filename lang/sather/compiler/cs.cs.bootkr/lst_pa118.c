...
ptr LST118_dup_();
LST118_put_kwdname_();
ptr LST118_sather_code_();
ptr LST118_initialize_();
ptr LST118_pcopy_();
LST118_clear_();
/*constant*/ int LST118_def_init_size_ = 5;
ptr LST118_push_();
int LST118_size_();
char LST118_is_empty_();
ptr LST118_pop_();
ptr LST118_top_();
LST118_init_iterate_();
ptr LST118_curr_item_();
ptr LST118_next_item_();
ptr LST118_prev_item_();
ptr LST118_push_unique_();
ptr LST118_append_();
ptr LST118_union_();
char LST118_not_in_();
int LST118_contains_();
extern int attr_ent_LST118[];

ptr LST118_create_(self__,init_size__)
ptr self__;
int init_size__;
{
   ptr res__ = 0;
...
LST118_out_of_line_(self__,fn__)
ptr self__;
ptr fn__;
{
...
LST118_put_kwdname_(self__,nm__)
ptr self__;
int nm__;
{
   ptr gl2931_;
...
ptr LST118_sather_code_(self__)
ptr self__;
{
   ptr res__ = 0;
...
ptr LST118_initialize_(self__,initarg__)
ptr self__;
ptr initarg__;
{
   ptr res__ = 0;
...
ptr LST118_pcopy_(self__,pl__,pi__)
ptr self__;
ptr pl__;
ptr pi__;
{
...
ptr LST118_push_unique_(self__,e__)
ptr self__;
ptr e__;
{
   ptr res__ = 0;
...
ptr LST118_append_(self__,list__)
ptr self__;
ptr list__;
{
   ptr res__ = 0;
...
ptr LST118_union_(self__,list__)
ptr self__;
ptr list__;
{
   ptr res__ = 0;
...
char LST118_not_in_(self__,e__)
ptr self__;
ptr e__;
{
   char res__ = S_char_VOID_;
...
int LST118_contains_(self__,e__)
ptr self__;
ptr e__;
{
   int res__ = S_int_VOID_;
