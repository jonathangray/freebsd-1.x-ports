...
ptr LST120_dup_();
LST120_put_kwdname_();
ptr LST120_sather_code_();
ptr LST120_initialize_();
LST120_resolve_predef_types_();
LST120_semant_();
ptr LST120_typeof_();
int LST120_get_offset_();
LST120_cprint_offset_();
ptr LST120_get_constval_();
LST120_cont_cprint_code_();
LST120_cprint_cname_();
LST120_cprint_extern_();
LST120_cprint_access_value_();
LST120_cprint_init_code_();
LST120_clear_();
/*constant*/ int LST120_def_init_size_ = 5;
ptr LST120_push_();
int LST120_size_();
char LST120_is_empty_();
ptr LST120_pop_();
ptr LST120_top_();
LST120_init_iterate_();
ptr LST120_curr_item_();
ptr LST120_next_item_();
ptr LST120_prev_item_();
ptr LST120_push_unique_();
ptr LST120_append_();
ptr LST120_union_();
char LST120_not_in_();
int LST120_contains_();
LST120_cprint_code_();
LST120_get_ext_strs_();
char LST120_valid_init_expr_();
ptr LST120_gen_temps_();
LST120_cprint_pre_code_();
LST120_cprint_act_code_();
extern int attr_ent_LST120[];

ptr LST120_create_(self__,init_size__)
ptr self__;
int init_size__;
{
   ptr res__ = 0;
...
LST120_out_of_line_(self__,fn__)
ptr self__;
ptr fn__;
{
   ptr gl2948_;
...
LST120_put_kwdname_(self__,nm__)
ptr self__;
int nm__;
{
   ptr gl2956_;
...
ptr LST120_sather_code_(self__)
ptr self__;
{
   ptr res__ = 0;
   ptr gl2959_;
...
ptr LST120_initialize_(self__,initarg__)
ptr self__;
ptr initarg__;
{
   ptr res__ = 0;
...
LST120_resolve_predef_types_(self__,index__)
ptr self__;
int index__;
{
   ptr gl2963_;
...
LST120_semant_(self__,symtab__)
ptr self__;
ptr symtab__;
{
   ptr gl2967_;
...
LST120_cprint_offset_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
ptr LST120_get_constval_(self__)
ptr self__;
{
   ptr res__ = 0;
...
LST120_cont_cprint_code_(self__,outfile__,cont__)
ptr self__;
ptr outfile__;
int cont__;
{
...
LST120_cprint_cname_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
LST120_cprint_extern_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
LST120_cprint_access_value_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
LST120_cprint_init_code_(self__,outfile__)
ptr self__;
ptr outfile__;
{
   ptr gl2978_;
...
ptr LST120_push_unique_(self__,e__)
ptr self__;
ptr e__;
{
   ptr res__ = 0;
...
ptr LST120_append_(self__,list__)
ptr self__;
ptr list__;
{
   ptr res__ = 0;
...
ptr LST120_union_(self__,list__)
ptr self__;
ptr list__;
{
   ptr res__ = 0;
...
char LST120_not_in_(self__,e__)
ptr self__;
ptr e__;
{
   char res__ = S_char_VOID_;
...
int LST120_contains_(self__,e__)
ptr self__;
ptr e__;
{
   int res__ = S_int_VOID_;
...
LST120_cprint_code_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
char LST120_valid_init_expr_(self__)
ptr self__;
{
   char res__ = S_char_VOID_;
   ptr gl2991_;
...
LST120_cprint_pre_code_(self__,outfile__)
ptr self__;
ptr outfile__;
{
   ptr gl3002_;
...
LST120_cprint_act_code_(self__,outfile__)
ptr self__;
ptr outfile__;
{
   ptr gl3006_;
