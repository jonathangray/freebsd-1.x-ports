...
ptr ATT153_initialize_();
/*constant*/ int ATT153_print_indent_ = 2;
ptr ATT153_create_();
ATT153_out_of_line_();
ptr ATT153_dup_();
ATT153_put_kwdname_();
ptr ATT153_sather_code_();
ATT153_resolve_predef_types_();
ATT153_semant_();
ptr ATT153_typeof_();
int ATT153_get_offset_();
ATT153_cprint_offset_();
ptr ATT153_get_constval_();
ATT153_cont_cprint_code_();
ATT153_cprint_cname_();
ATT153_cprint_extern_();
ATT153_cprint_access_value_();
ATT153_cprint_init_code_();
...
int ATT153_class_inst_ind_();
int ATT153_featob_s_name_();
ATT153_mark_private_();
ATT153_mark_abstract_();
ATT153_mark_spec_();
ATT153_mark_shared_();
ATT153_mark_readonly_();
char ATT153_undefined_p_();
int ATT153_compute_own_offset_();
ATT153_eval_constant_();
ptr ATT153_rettype_();
ATT153_remember_local_();
ATT153_semant_prologue_();
ATT153_do_gen_temps_();
ATT153_gen_goto_tags_();
ATT153_validate_dispatches_and_get_ext_strs_();
char ATT153_compatible_des_feat_();
ATT153_update_used_in_dispatch_();
ATT153_consistent_defs_();
ATT153_cprint_decln_();
ATT153_cprint_routine_();
ATT153_cprint_store_dispval_();
int ATT153_declob_s_name_();
ATT153_cprint_code_();
/*constant*/ int ATT153_c_int_size_ = 4;
/*constant*/ int ATT153_cont1_ = 1;
extern int attr_ent_ATT153[];

ptr ATT153_initialize_(self__,initarg__)
ptr self__;
ptr initarg__;
{
   ptr res__ = 0;
...
ptr ATT153_create_(self__,nm__,t__,priv__,c_def__,ln__)
ptr self__;
int nm__;
ptr t__;
char priv__;
...
ATT153_out_of_line_(self__,fn__)
ptr self__;
ptr fn__;
{
...
ATT153_put_kwdname_(self__,nm__)
ptr self__;
int nm__;
{
   ptr gl4265_;
...
ptr ATT153_sather_code_(self__)
ptr self__;
{
   ptr res__ = 0;
...
ATT153_resolve_predef_types_(self__,index__)
ptr self__;
int index__;
{
   ptr gl4274_;
...
ATT153_semant_(self__,symtab__)
ptr self__;
ptr symtab__;
{
   ptr gl4277_;
...
ptr ATT153_get_constval_(self__)
ptr self__;
{
   ptr res__ = 0;
...
ATT153_cont_cprint_code_(self__,outfile__,cont__)
ptr self__;
ptr outfile__;
int cont__;
{
...
ATT153_cprint_cname_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
ATT153_cprint_extern_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
ATT153_cprint_access_value_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
ATT153_cprint_init_code_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
int ATT153_class_inst_ind_(self__)
ptr self__;
{
   int res__ = S_int_VOID_;
...
int ATT153_featob_s_name_(self__)
ptr self__;
{
   int res__ = S_int_VOID_;
...
char ATT153_undefined_p_(self__)
ptr self__;
{
...
int ATT153_compute_own_offset_(self__,nextloc__)
ptr self__;
int nextloc__;
{
   int res__ = S_int_VOID_;
...
ATT153_remember_local_(self__,lvar__)
ptr self__;
ptr lvar__;
{
...
ATT153_semant_prologue_(self__)
ptr self__;
{
...
ATT153_validate_dispatches_and_get_ext_strs_(self__)
ptr self__;
{
...
char ATT153_compatible_des_feat_(self__,feat__,lval_p__)
ptr self__;
ptr feat__;
char lval_p__;
{
...
ATT153_consistent_defs_(self__,nm__,lval_p__)
ptr self__;
int nm__;
char lval_p__;
{
...
ATT153_cprint_decln_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
ATT153_cprint_routine_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
ATT153_cprint_store_dispval_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
int ATT153_declob_s_name_(self__)
ptr self__;
{
   int res__ = S_int_VOID_;
...
ATT153_cprint_code_(self__,outfile__)
ptr self__;
ptr outfile__;
{
