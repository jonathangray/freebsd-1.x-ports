...
char SAT95_base_classname_p_();
/*shared*/ int SAT95_array_str_ind_;
SAT95_error_msg_();
SAT95_error_exit_();
char SAT95_install_predefined_classes_();
int SAT95_install_root_classes_();
SAT95_all_create_inst_();
SAT95_all_expand_cinh_();
SAT95_all_resolve_predef_types_and_compute_num_attrs_();
SAT95_all_compute_anc_and_des_and_time_stamp_();
SAT95_print_descendant_information_();
SAT95_all_compute_attr_offsets_();
SAT95_find_called_features_();
SAT95_all_semant_();
SAT95_final_pass_();
SAT95_all_class_inst_cprint_();
SAT95_cprint_macros_();
SAT95_cs_options_cprint_();
SAT95_cprint_class_info_();
SAT95_cprint_init_();
/*shared*/ int SAT95_total_externs_;
/*shared*/ char SAT95_externs_done_;
SAT95_cprint_init_externs_();
SAT95_cprint_init_shareds_and_consts_();
SAT95_cprint_init_feats_();
SAT95_cprint_rt_static_();
SAT95_print_defines_();
SAT95_print_sather_to_c_macros_();
SAT95_print_browser_info_();
SAT95_old_version_print_sather_to_c_macros_();
SAT95_print_makefile_();
char SAT95_argv_needed_();
char SAT95_old_version_argv_needed_();
ptr SAT95_get_simple_classnames_();
int SAT95_get_array_str_ind_();
SAT95_print_gen_rt_table_();
extern int attr_ent_SAT95[];

ptr SAT95_initialize_(self__,initarg__)
ptr self__;
ptr initarg__;
{
   ptr res__ = 0;
...
char SAT95_base_classname_p_(self__,i__)
ptr self__;
int i__;
{
...
char SAT95_install_predefined_classes_(self__)
ptr self__;
{
   char res__ = S_char_VOID_;
...
int SAT95_install_root_classes_(self__,names__)
ptr self__;
ptr names__;
{
...
SAT95_all_resolve_predef_types_and_compute_num_attrs_(self__,used_classes__)
ptr self__;
ptr used_classes__;
{
...
SAT95_all_compute_anc_and_des_and_time_stamp_(self__)
ptr self__;
{
   int    i__ = S_int_VOID_;
   ptr    co__ = 0;
...
SAT95_print_descendant_information_(self__)
ptr self__;
{
...
SAT95_all_compute_attr_offsets_(self__)
ptr self__;
{
   int    i__ = S_int_VOID_;
...
SAT95_find_called_features_(self__)
ptr self__;
{
...
SAT95_all_class_inst_cprint_(self__)
ptr self__;
{
...
SAT95_cprint_class_info_(self__)
ptr self__;
{
...
SAT95_cprint_init_shareds_and_consts_(self__)
ptr self__;
{
...
SAT95_print_defines_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
SAT95_print_sather_to_c_macros_(self__)
ptr self__;
{
   SATHER_STR_(20,19,ls1253_,"Error in opening \"");
   SATHER_STR_(20,3,ls632_,"\"\n");
...
SAT95_print_browser_info_(self__)
ptr self__;
{
...
SAT95_old_version_print_sather_to_c_macros_(self__)
ptr self__;
{
   SATHER_STR_(20,19,ls1253_,"Error in opening \"");
   SATHER_STR_(20,3,ls632_,"\"\n");
...
char SAT95_argv_needed_(self__)
ptr self__;
{
   char res__ = S_char_VOID_;
   ptr gl1147_;
...
char SAT95_old_version_argv_needed_(self__)
ptr self__;
{
   char res__ = S_char_VOID_;
...
ptr SAT95_get_simple_classnames_(self__)
ptr self__;
{
   ptr res__ = 0;
...
int SAT95_get_array_str_ind_(self__)
ptr self__;
{
   int res__ = S_int_VOID_;
...
SAT95_print_gen_rt_table_(self__,outfile__,table_prefix__,cond__)
ptr self__;
ptr outfile__;
ptr table_prefix__;
char cond__;
