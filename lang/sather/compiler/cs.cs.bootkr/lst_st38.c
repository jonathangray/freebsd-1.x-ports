...
ptr LST38_dup_();
LST38_put_kwdname_();
ptr LST38_sather_code_();
ptr LST38_initialize_();
ptr LST38_pcopy_();
LST38_clear_();
/*constant*/ int LST38_def_init_size_ = 5;
ptr LST38_push_();
int LST38_size_();
char LST38_is_empty_();
ptr LST38_pop_();
ptr LST38_top_();
LST38_init_iterate_();
ptr LST38_curr_item_();
ptr LST38_next_item_();
ptr LST38_prev_item_();
ptr LST38_push_unique_();
ptr LST38_append_();
ptr LST38_union_();
char LST38_not_in_();
int LST38_contains_();
...
ptr LST38_create_(self__,init_size__)
ptr self__;
int init_size__;
{
   ptr res__ = 0;
...
LST38_out_of_line_(self__,fn__)
ptr self__;
ptr fn__;
{
...
LST38_put_kwdname_(self__,nm__)
ptr self__;
int nm__;
{
   ptr gl621_;
...
ptr LST38_initialize_(self__,initarg__)
ptr self__;
ptr initarg__;
{
   ptr res__ = 0;
...
ptr LST38_pcopy_(self__,pl__,pi__)
ptr self__;
ptr pl__;
ptr pi__;
{
...
ptr LST38_push_unique_(self__,e__)
ptr self__;
ptr e__;
{
   ptr res__ = 0;
...
ptr LST38_append_(self__,list__)
ptr self__;
ptr list__;
{
   ptr res__ = 0;
...
ptr LST38_union_(self__,list__)
ptr self__;
ptr list__;
{
   ptr res__ = 0;
...
int LST38_contains_(self__,e__)
ptr self__;
ptr e__;
{
   int res__ = S_int_VOID_;
