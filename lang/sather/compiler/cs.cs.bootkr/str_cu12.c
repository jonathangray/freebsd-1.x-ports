...
char STR12_first_();
char STR12_next_();
int STR12_space_size_();
ptr STR12_skip_space_();
char STR12_is_done_();
ptr STR12_reassign_();
char STR12_c_equals_();
char STR12_c_accept_();
ptr STR12_get_s_cut_();
ptr STR12_get_word_();
int STR12_update_i_();
float STR12_update_r_();
extern int attr_ent_STR12[];

ptr STR12_create_(self__,st__)
ptr self__;
ptr st__;
{
   ptr res__ = 0;
...
int STR12_digits_size_(self__,i__)
ptr self__;
int i__;
{
   int res__ = S_int_VOID_;
...
int STR12_space_size_(self__,i__)
ptr self__;
int i__;
{
   int res__ = S_int_VOID_;
...
ptr STR12_reassign_(self__,str__)
ptr self__;
ptr str__;
{
   ptr res__ = 0;
...
char STR12_c_equals_(self__,c__)
ptr self__;
char c__;
{
   char res__ = S_char_VOID_;
...
char STR12_c_accept_(self__,c__)
ptr self__;
char c__;
{
   char res__ = S_char_VOID_;
...
ptr STR12_get_s_cut_(self__,cutset__)
ptr self__;
ptr cutset__;
{
   ptr res__ = 0;
...
int STR12_update_i_(self__,x__)
ptr self__;
int x__;
{
   int res__ = S_int_VOID_;
...
float STR12_update_r_(self__,x__)
ptr self__;
float x__;
{
   float res__ = S_float_VOID_;
