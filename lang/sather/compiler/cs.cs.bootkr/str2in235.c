...
ptr STR235_gets_();
char STR235_insert_();
ptr STR235_initialize_();
extern int attr_ent_STR235[];

ptr STR235_create_(self__)
ptr self__;
{
   ptr res__ = 0;
...
char STR235_insert_(self__,s__,v__)
ptr self__;
ptr s__;
int v__;
{
...
ptr STR235_initialize_(self__,initarg__)
ptr self__;
ptr initarg__;
{
   ptr res__ = 0;
