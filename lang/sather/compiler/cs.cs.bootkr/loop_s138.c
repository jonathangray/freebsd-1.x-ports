...
ptr LOO138_dup_();
LOO138_put_kwdname_();
ptr LOO138_sather_code_();
ptr LOO138_initialize_();
LOO138_resolve_predef_types_();
LOO138_semant_();
ptr LOO138_typeof_();
int LOO138_get_offset_();
LOO138_cprint_offset_();
ptr LOO138_get_constval_();
LOO138_cont_cprint_code_();
LOO138_cprint_cname_();
LOO138_cprint_extern_();
LOO138_cprint_access_value_();
LOO138_cprint_init_code_();
char LOO138_typechk_exprs_();
ptr LOO138_gen_temps_();
LOO138_gen_goto_tags_();
LOO138_validate_dispatches_and_get_ext_strs_();
LOO138_cprint_code_();
int LOO138_get_goto_tag_();
extern int attr_ent_LOO138[];

ptr LOO138_create_(self__,t__,s__,ln__)
ptr self__;
ptr t__;
ptr s__;
int ln__;
...
LOO138_out_of_line_(self__,fn__)
ptr self__;
ptr fn__;
{
...
LOO138_put_kwdname_(self__,nm__)
ptr self__;
int nm__;
{
   ptr gl3377_;
...
ptr LOO138_sather_code_(self__)
ptr self__;
{
   ptr res__ = 0;
...
ptr LOO138_initialize_(self__,initarg__)
ptr self__;
ptr initarg__;
{
   ptr res__ = 0;
...
LOO138_resolve_predef_types_(self__,index__)
ptr self__;
int index__;
{
   ptr gl3380_;
...
LOO138_semant_(self__,symtab__)
ptr self__;
ptr symtab__;
{
...
LOO138_cprint_offset_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
ptr LOO138_get_constval_(self__)
ptr self__;
{
   ptr res__ = 0;
...
LOO138_cont_cprint_code_(self__,outfile__,cont__)
ptr self__;
ptr outfile__;
int cont__;
{
...
LOO138_cprint_cname_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
LOO138_cprint_extern_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
LOO138_cprint_access_value_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
LOO138_cprint_init_code_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
char LOO138_typechk_exprs_(self__,tp__)
ptr self__;
ptr tp__;
{
...
LOO138_gen_goto_tags_(self__,block__)
ptr self__;
ptr block__;
{
...
LOO138_validate_dispatches_and_get_ext_strs_(self__)
ptr self__;
{
   ptr gl3410_;
   static int gl3411_;
...
LOO138_cprint_code_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
int LOO138_get_goto_tag_(self__)
ptr self__;
{
   int res__ = S_int_VOID_;
