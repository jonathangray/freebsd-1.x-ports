...
char STR69_base_classname_p_();
/*constant*/ int STR69_init_size_ = 2000;
ptr STR69_create_();
STR69_augment_();
char STR69_reserved_name_p_();
int STR69_hash_string_();
int STR69_hash_string_buf_();
int STR69_index_of_str_();
int STR69_insert_str_();
int STR69_find_str_();
STR69_double_tables_();
ptr STR69_at_index_();
extern int attr_ent_STR69[];

ptr STR69_initialize_(self__,initarg__)
ptr self__;
ptr initarg__;
{
   ptr res__ = 0;
...
char STR69_base_classname_p_(self__,i__)
ptr self__;
int i__;
{
...
char STR69_reserved_name_p_(self__,nm__)
ptr self__;
int nm__;
{
   char res__ = S_char_VOID_;
...
int STR69_hash_string_(self__,s__)
ptr self__;
ptr s__;
{
...
int STR69_hash_string_buf_(self__,s__)
ptr self__;
ptr s__;
{
   int res__ = S_int_VOID_;
...
int STR69_index_of_str_(self__,s__)
ptr self__;
ptr s__;
{
   int res__ = S_int_VOID_;
...
int STR69_insert_str_(self__,s__)
ptr self__;
ptr s__;
{
   int res__ = S_int_VOID_;
...
int STR69_find_str_(self__,s__)
ptr self__;
ptr s__;
{
   int res__ = S_int_VOID_;
...
ptr STR69_at_index_(self__,i__)
ptr self__;
int i__;
{
   ptr res__ = 0;
