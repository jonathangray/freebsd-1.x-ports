...
OBJ100_start_();
OBJ100_terminate_();
ptr OBJ100_cmacro_def_();
OBJ100_insert_();
ptr OBJ100_create_();
int OBJ100_info_size_();
ptr OBJ100_ith_str_();
ptr OBJ100_ith_info_();
OBJ100_cprint_self_();
ptr OBJ100_initialize_();
/*constant*/ int OBJ100_init_num_OBJECT_FILES_ = 5;
extern int attr_ent_OBJ100[];

OBJ100_error_msg_(self__,s__)
ptr self__;
ptr s__;
{
...
ptr OBJ100_cmacro_def_(self__,i__)
ptr self__;
int i__;
{
   ptr res__ = 0;
...
ptr OBJ100_ith_str_(self__,i__)
ptr self__;
int i__;
{
   ptr res__ = 0;
...
ptr OBJ100_ith_info_(self__,i__)
ptr self__;
int i__;
{
   ptr res__ = 0;
...
OBJ100_cprint_self_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
ptr OBJ100_initialize_(self__,initarg__)
ptr self__;
ptr initarg__;
{
   ptr res__ = 0;
