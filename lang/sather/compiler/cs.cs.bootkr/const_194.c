...
ptr CON194_dup_();
CON194_put_kwdname_();
ptr CON194_sather_code_();
ptr CON194_initialize_();
CON194_resolve_predef_types_();
CON194_semant_();
ptr CON194_typeof_();
int CON194_get_offset_();
CON194_cprint_offset_();
ptr CON194_get_constval_();
CON194_cont_cprint_code_();
CON194_cprint_cname_();
CON194_cprint_extern_();
CON194_cprint_access_value_();
CON194_cprint_init_code_();
char CON194_valid_init_expr_();
char CON194_assignable_p_();
ptr CON194_gen_temps_();
ptr CON194_expr_eval_constant_();
CON194_get_ext_strs_();
char CON194_to_be_pre_evaluated_();
char CON194_access_value_only_();
CON194_fob_error_();
CON194_cprint_pre_code_();
CON194_cprint_act_code_();
CON194_cprint_cast_code_();
ptr CON194_val_();
extern int attr_ent_CON194[];

ptr CON194_create_(self__,ln__)
ptr self__;
int ln__;
{
   ptr res__ = 0;
...
CON194_out_of_line_(self__,fn__)
ptr self__;
ptr fn__;
{
...
CON194_put_kwdname_(self__,nm__)
ptr self__;
int nm__;
{
   ptr gl4712_;
...
ptr CON194_sather_code_(self__)
ptr self__;
{
   ptr res__ = 0;
...
ptr CON194_initialize_(self__,initarg__)
ptr self__;
ptr initarg__;
{
   ptr res__ = 0;
...
CON194_resolve_predef_types_(self__,index__)
ptr self__;
int index__;
{
...
CON194_semant_(self__,symtab__)
ptr self__;
ptr symtab__;
{
...
CON194_cprint_offset_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
ptr CON194_get_constval_(self__)
ptr self__;
{
   ptr res__ = 0;
...
CON194_cont_cprint_code_(self__,outfile__,cont__)
ptr self__;
ptr outfile__;
int cont__;
{
...
CON194_cprint_cname_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
CON194_cprint_extern_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
CON194_cprint_access_value_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
CON194_cprint_init_code_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
char CON194_valid_init_expr_(self__)
ptr self__;
{
...
char CON194_assignable_p_(self__)
ptr self__;
{
   char res__ = S_char_VOID_;
...
ptr CON194_expr_eval_constant_(self__)
ptr self__;
{
   ptr res__ = 0;
...
char CON194_to_be_pre_evaluated_(self__)
ptr self__;
{
   char res__ = S_char_VOID_;
...
char CON194_access_value_only_(self__)
ptr self__;
{
   char res__ = S_char_VOID_;
...
CON194_fob_error_(self__,op_name__,cls_name__)
ptr self__;
ptr op_name__;
ptr cls_name__;
{
...
CON194_cprint_pre_code_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
CON194_cprint_act_code_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
CON194_cprint_cast_code_(self__,outfile__)
ptr self__;
ptr outfile__;
{
