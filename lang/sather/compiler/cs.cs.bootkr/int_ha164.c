...
char INT164_get_();
char INT164_test_();
ptr INT164_double_size_();
ptr INT164_insert_();
INT164_delete_();
int INT164_size_();
ptr INT164_cursor_();
ptr INT164_union_();
ptr INT164_intersection_();
ptr INT164_difference_();
ptr INT164_sym_difference_();
char INT164_is_a_subset_of_();
ptr INT164_initialize_();
...
ptr INT164_double_size_(self__)
ptr self__;
{
   ptr res__ = 0;
...
ptr INT164_intersection_(self__,s__)
ptr self__;
ptr s__;
{
   ptr res__ = 0;
...
ptr INT164_difference_(self__,s__)
ptr self__;
ptr s__;
{
   ptr res__ = 0;
...
ptr INT164_sym_difference_(self__,s__)
ptr self__;
ptr s__;
{
   ptr res__ = 0;
...
char INT164_is_a_subset_of_(self__,s__)
ptr self__;
ptr s__;
{
   char res__ = S_char_VOID_;
...
ptr INT164_initialize_(self__,initarg__)
ptr self__;
ptr initarg__;
{
   ptr res__ = 0;
