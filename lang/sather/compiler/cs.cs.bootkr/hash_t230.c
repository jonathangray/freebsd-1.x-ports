...
int HAS230_hash_();
ptr HAS230_get_obj_();
char HAS230_add_obj_();
HAS230_add_unique_obj_();
HAS230_double_tables_();
char HAS230_remove_obj_();
ptr HAS230_initialize_();
extern int attr_ent_HAS230[];

ptr HAS230_create_(self__,size__)
ptr self__;
int size__;
{
   ptr res__ = 0;
...
ptr HAS230_get_obj_(self__,nm__)
ptr self__;
int nm__;
{
   ptr res__ = 0;
...
char HAS230_add_obj_(self__,nm__,ob__)
ptr self__;
int nm__;
ptr ob__;
{
...
char HAS230_remove_obj_(self__,nm__)
ptr self__;
int nm__;
{
   char res__ = S_char_VOID_;
...
ptr HAS230_initialize_(self__,initarg__)
ptr self__;
ptr initarg__;
{
   ptr res__ = 0;
