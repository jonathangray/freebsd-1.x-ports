...
ptr GEN229_item_();
ptr GEN229_next_();
ptr GEN229_initialize_();
extern int attr_ent_GEN229[];

ptr GEN229_create_(self__,nt__)
ptr self__;
ptr nt__;
{
   ptr res__ = 0;
...
ptr GEN229_initialize_(self__,initarg__)
ptr self__;
ptr initarg__;
{
   ptr res__ = 0;
