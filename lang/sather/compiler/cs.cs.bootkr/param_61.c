...
ptr PAR61_dup_();
PAR61_put_kwdname_();
ptr PAR61_sather_code_();
ptr PAR61_initialize_();
ptr PAR61_pcopy_();
PAR61_mark_private_();
ptr PAR61_create_lst_();
extern int attr_ent_PAR61[];

ptr PAR61_create_(self__,nm__,tp__,ln__)
ptr self__;
int nm__;
ptr tp__;
int ln__;
...
PAR61_out_of_line_(self__,fn__)
ptr self__;
ptr fn__;
{
...
PAR61_put_kwdname_(self__,nm__)
ptr self__;
int nm__;
{
   ptr gl905_;
...
ptr PAR61_initialize_(self__,initarg__)
ptr self__;
ptr initarg__;
{
   ptr res__ = 0;
...
ptr PAR61_pcopy_(self__,pl__,pi__)
ptr self__;
ptr pl__;
ptr pi__;
{
...
ptr PAR61_create_lst_(self__,do__)
ptr self__;
ptr do__;
{
   ptr res__ = 0;
