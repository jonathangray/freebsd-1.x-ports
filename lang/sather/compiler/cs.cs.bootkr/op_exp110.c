...
ptr OP_110_dup_();
OP_110_put_kwdname_();
ptr OP_110_sather_code_();
ptr OP_110_initialize_();
OP_110_resolve_predef_types_();
OP_110_semant_();
ptr OP_110_typeof_();
int OP_110_get_offset_();
OP_110_cprint_offset_();
ptr OP_110_get_constval_();
OP_110_cont_cprint_code_();
OP_110_cprint_cname_();
OP_110_cprint_extern_();
OP_110_cprint_access_value_();
OP_110_cprint_init_code_();
char OP_110_valid_init_expr_();
char OP_110_assignable_p_();
ptr OP_110_gen_temps_();
ptr OP_110_expr_eval_constant_();
OP_110_get_ext_strs_();
char OP_110_to_be_pre_evaluated_();
char OP_110_access_value_only_();
OP_110_fob_error_();
OP_110_cprint_pre_code_();
OP_110_cprint_act_code_();
OP_110_cprint_cast_code_();
...
OP_110_cprint_ith_child_pre_code_();
OP_110_cprint_ith_child_act_code_();
extern int attr_ent_OP_110[];

ptr OP_110_create_(self__,op__,children__,ln__)
ptr self__;
int op__;
ptr children__;
int ln__;
...
OP_110_out_of_line_(self__,fn__)
ptr self__;
ptr fn__;
{
...
OP_110_put_kwdname_(self__,nm__)
ptr self__;
int nm__;
{
   ptr gl1361_;
...
ptr OP_110_sather_code_(self__)
ptr self__;
{
   ptr res__ = 0;
...
ptr OP_110_initialize_(self__,initarg__)
ptr self__;
ptr initarg__;
{
   ptr res__ = 0;
...
OP_110_resolve_predef_types_(self__,index__)
ptr self__;
int index__;
{
...
OP_110_semant_(self__,symtab__)
ptr self__;
ptr symtab__;
{
...
OP_110_cprint_offset_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
ptr OP_110_get_constval_(self__)
ptr self__;
{
   ptr res__ = 0;
...
OP_110_cont_cprint_code_(self__,outfile__,cont__)
ptr self__;
ptr outfile__;
int cont__;
{
...
OP_110_cprint_cname_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
OP_110_cprint_extern_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
OP_110_cprint_access_value_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
OP_110_cprint_init_code_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
char OP_110_valid_init_expr_(self__)
ptr self__;
{
...
char OP_110_assignable_p_(self__)
ptr self__;
{
   char res__ = S_char_VOID_;
...
ptr OP_110_expr_eval_constant_(self__)
ptr self__;
{
   ptr res__ = 0;
   ptr gl1492_;
...
char OP_110_to_be_pre_evaluated_(self__)
ptr self__;
{
   char res__ = S_char_VOID_;
...
char OP_110_access_value_only_(self__)
ptr self__;
{
   char res__ = S_char_VOID_;
...
OP_110_fob_error_(self__,op_name__,cls_name__)
ptr self__;
ptr op_name__;
ptr cls_name__;
{
...
OP_110_cprint_pre_code_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
OP_110_cprint_act_code_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
OP_110_cprint_ith_child_pre_code_(self__,i__,outfile__)
ptr self__;
int i__;
ptr outfile__;
{
...
OP_110_cprint_ith_child_act_code_(self__,i__,outfile__)
ptr self__;
int i__;
ptr outfile__;
{
