...
ptr EXP36_dup_();
EXP36_put_kwdname_();
ptr EXP36_sather_code_();
ptr EXP36_initialize_();
ptr EXP36_pcopy_();
extern int attr_ent_EXP36[];

ptr EXP36_create_(self__)
ptr self__;
{
   ptr res__ = 0;
...
EXP36_out_of_line_(self__,fn__)
ptr self__;
ptr fn__;
{
...
EXP36_put_kwdname_(self__,nm__)
ptr self__;
int nm__;
{
   ptr gl606_;
...
ptr EXP36_initialize_(self__,initarg__)
ptr self__;
ptr initarg__;
{
   ptr res__ = 0;
...
ptr EXP36_pcopy_(self__,pl__,pi__)
ptr self__;
ptr pl__;
ptr pi__;
{
