...
ptr LST43_dup_();
LST43_put_kwdname_();
ptr LST43_sather_code_();
ptr LST43_initialize_();
ptr LST43_pcopy_();
LST43_clear_();
/*constant*/ int LST43_def_init_size_ = 5;
ptr LST43_push_();
int LST43_size_();
char LST43_is_empty_();
ptr LST43_pop_();
ptr LST43_top_();
LST43_init_iterate_();
ptr LST43_curr_item_();
ptr LST43_next_item_();
ptr LST43_prev_item_();
ptr LST43_push_unique_();
ptr LST43_append_();
ptr LST43_union_();
char LST43_not_in_();
int LST43_contains_();
LST43_mark_private_();
LST43_mark_spec_();
LST43_mark_abstract_();
LST43_mark_shared_();
LST43_mark_readonly_();
/*shared*/ char LST43_duplicate_defs_ok_;
ptr LST43_add_unique_feat_();
extern int attr_ent_LST43[];

ptr LST43_create_(self__,init_size__)
ptr self__;
int init_size__;
{
   ptr res__ = 0;
...
LST43_out_of_line_(self__,fn__)
ptr self__;
ptr fn__;
{
...
LST43_put_kwdname_(self__,nm__)
ptr self__;
int nm__;
{
   ptr gl669_;
...
ptr LST43_initialize_(self__,initarg__)
ptr self__;
ptr initarg__;
{
   ptr res__ = 0;
...
ptr LST43_pcopy_(self__,pl__,pi__)
ptr self__;
ptr pl__;
ptr pi__;
{
...
ptr LST43_push_unique_(self__,e__)
ptr self__;
ptr e__;
{
   ptr res__ = 0;
...
ptr LST43_append_(self__,list__)
ptr self__;
ptr list__;
{
   ptr res__ = 0;
...
ptr LST43_union_(self__,list__)
ptr self__;
ptr list__;
{
   ptr res__ = 0;
...
int LST43_contains_(self__,e__)
ptr self__;
ptr e__;
{
   int res__ = S_int_VOID_;
...
ptr LST43_add_unique_feat_(self__,f__)
ptr self__;
ptr f__;
{
   ptr res__ = 0;
