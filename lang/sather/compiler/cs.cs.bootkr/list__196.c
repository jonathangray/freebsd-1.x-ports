...
ptr LIS196_push_();
int LIS196_size_();
char LIS196_is_empty_();
ptr LIS196_pop_();
ptr LIS196_top_();
LIS196_init_iterate_();
ptr LIS196_curr_item_();
ptr LIS196_next_item_();
ptr LIS196_prev_item_();
ptr LIS196_push_unique_();
ptr LIS196_append_();
ptr LIS196_union_();
char LIS196_not_in_();
int LIS196_contains_();
ptr LIS196_initialize_();
extern int attr_ent_LIS196[];

LIS196_clear_(self__)
ptr self__;
{
   int    i__ = S_int_VOID_;
...
ptr LIS196_create_(self__,init_size__)
ptr self__;
int init_size__;
{
   ptr res__ = 0;
...
ptr LIS196_push_unique_(self__,e__)
ptr self__;
ptr e__;
{
   ptr res__ = 0;
...
ptr LIS196_append_(self__,list__)
ptr self__;
ptr list__;
{
   ptr res__ = 0;
...
ptr LIS196_union_(self__,list__)
ptr self__;
ptr list__;
{
   ptr res__ = 0;
...
char LIS196_not_in_(self__,e__)
ptr self__;
ptr e__;
{
   char res__ = S_char_VOID_;
...
int LIS196_contains_(self__,e__)
ptr self__;
ptr e__;
{
   int res__ = S_int_VOID_;
...
ptr LIS196_initialize_(self__,initarg__)
ptr self__;
ptr initarg__;
{
   ptr res__ = 0;
