...
ptr CON140_dup_();
CON140_put_kwdname_();
ptr CON140_sather_code_();
ptr CON140_initialize_();
CON140_resolve_predef_types_();
CON140_semant_();
ptr CON140_typeof_();
int CON140_get_offset_();
CON140_cprint_offset_();
ptr CON140_get_constval_();
CON140_cont_cprint_code_();
CON140_cprint_cname_();
CON140_cprint_extern_();
CON140_cprint_access_value_();
CON140_cprint_init_code_();
char CON140_typechk_exprs_();
ptr CON140_gen_temps_();
CON140_gen_goto_tags_();
CON140_validate_dispatches_and_get_ext_strs_();
CON140_cprint_code_();
CON140_cprint_elsif_code_();
extern int attr_ent_CON140[];

ptr CON140_create_(self__,t__,tp__,eip__,ep__,ln__)
ptr self__;
ptr t__;
ptr tp__;
ptr eip__;
...
CON140_out_of_line_(self__,fn__)
ptr self__;
ptr fn__;
{
...
CON140_put_kwdname_(self__,nm__)
ptr self__;
int nm__;
{
   ptr gl3470_;
...
ptr CON140_sather_code_(self__)
ptr self__;
{
   ptr res__ = 0;
...
ptr CON140_initialize_(self__,initarg__)
ptr self__;
ptr initarg__;
{
   ptr res__ = 0;
...
CON140_resolve_predef_types_(self__,index__)
ptr self__;
int index__;
{
   ptr gl3473_;
...
CON140_semant_(self__,symtab__)
ptr self__;
ptr symtab__;
{
...
CON140_cprint_offset_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
ptr CON140_get_constval_(self__)
ptr self__;
{
   ptr res__ = 0;
...
CON140_cont_cprint_code_(self__,outfile__,cont__)
ptr self__;
ptr outfile__;
int cont__;
{
...
CON140_cprint_cname_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
CON140_cprint_extern_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
CON140_cprint_access_value_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
CON140_cprint_init_code_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
char CON140_typechk_exprs_(self__,tp__)
ptr self__;
ptr tp__;
{
...
CON140_gen_goto_tags_(self__,block__)
ptr self__;
ptr block__;
{
...
CON140_validate_dispatches_and_get_ext_strs_(self__)
ptr self__;
{
   ptr gl3503_;
   static int gl3504_;
...
CON140_cprint_code_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
CON140_cprint_elsif_code_(self__,outfile__,level__)
ptr self__;
ptr outfile__;
int level__;
{
