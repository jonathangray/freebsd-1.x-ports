...
ptr LIS201_push_();
int LIS201_size_();
char LIS201_is_empty_();
ptr LIS201_pop_();
ptr LIS201_top_();
LIS201_init_iterate_();
ptr LIS201_curr_item_();
ptr LIS201_next_item_();
ptr LIS201_prev_item_();
ptr LIS201_push_unique_();
ptr LIS201_append_();
ptr LIS201_union_();
char LIS201_not_in_();
int LIS201_contains_();
ptr LIS201_initialize_();
extern int attr_ent_LIS201[];

LIS201_clear_(self__)
ptr self__;
{
   int    i__ = S_int_VOID_;
...
ptr LIS201_create_(self__,init_size__)
ptr self__;
int init_size__;
{
   ptr res__ = 0;
...
ptr LIS201_push_unique_(self__,e__)
ptr self__;
ptr e__;
{
   ptr res__ = 0;
...
ptr LIS201_append_(self__,list__)
ptr self__;
ptr list__;
{
   ptr res__ = 0;
...
ptr LIS201_union_(self__,list__)
ptr self__;
ptr list__;
{
   ptr res__ = 0;
...
char LIS201_not_in_(self__,e__)
ptr self__;
ptr e__;
{
   char res__ = S_char_VOID_;
...
int LIS201_contains_(self__,e__)
ptr self__;
ptr e__;
{
   int res__ = S_int_VOID_;
...
ptr LIS201_initialize_(self__,initarg__)
ptr self__;
ptr initarg__;
{
   ptr res__ = 0;
