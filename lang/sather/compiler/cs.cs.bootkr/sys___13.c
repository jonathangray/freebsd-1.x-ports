...
char SYS13_init_();
int SYS13_number_of_classes_();
int SYS13_class_index_();
ptr SYS13_class_name_();
int SYS13_class_base_size_();
int SYS13_class_c_type_();
int SYS13_class_number_of_features_();
int SYS13_class_array_dim_();
int SYS13_class_array_c_type_();
int SYS13_class_number_of_attributes_();
int SYS13_class_attribute_c_type_();
int SYS13_class_array_element_type_();
char SYS13_is_a_descendent_of_();
ptr SYS13_feature_name_();
int SYS13_feature_category_();
int SYS13_feature_index_();
int SYS13_feature_type_();
int SYS13_feature_c_type_();
int SYS13_feature_location_();
extern int attr_ent_SYS13[];

char SYS13_init_(self__)
ptr self__;
{
...
int SYS13_number_of_classes_(self__)
ptr self__;
{
...
int SYS13_class_index_(self__,nm__)
ptr self__;
ptr nm__;
{
   int res__ = S_int_VOID_;
...
ptr SYS13_class_name_(self__,i__)
ptr self__;
int i__;
{
   ptr res__ = 0;
...
int SYS13_class_base_size_(self__,i__)
ptr self__;
int i__;
{
   int res__ = S_int_VOID_;
...
int SYS13_class_c_type_(self__,i__)
ptr self__;
int i__;
{
   int res__ = S_int_VOID_;
...
int SYS13_class_number_of_features_(self__,i__)
ptr self__;
int i__;
{
   int res__ = S_int_VOID_;
...
int SYS13_class_array_dim_(self__,i__)
ptr self__;
int i__;
{
   int res__ = S_int_VOID_;
...
int SYS13_class_array_c_type_(self__,i__)
ptr self__;
int i__;
{
   int res__ = S_int_VOID_;
...
int SYS13_class_number_of_attributes_(self__,i__)
ptr self__;
int i__;
{
   int res__ = S_int_VOID_;
...
int SYS13_class_attribute_c_type_(self__,ci__,a__)
ptr self__;
int ci__;
int a__;
{
...
int SYS13_class_array_element_type_(self__,i__)
ptr self__;
int i__;
{
   int res__ = S_int_VOID_;
...
char SYS13_is_a_descendent_of_(self__,i__,j__)
ptr self__;
int i__;
int j__;
{
...
ptr SYS13_feature_name_(self__,ci__,f__)
ptr self__;
int ci__;
int f__;
{
...
int SYS13_feature_category_(self__,ci__,f__)
ptr self__;
int ci__;
int f__;
{
...
int SYS13_feature_index_(self__,ci__,f__)
ptr self__;
int ci__;
ptr f__;
{
...
int SYS13_feature_type_(self__,ci__,f__)
ptr self__;
int ci__;
int f__;
{
...
int SYS13_feature_c_type_(self__,ci__,f__)
ptr self__;
int ci__;
int f__;
{
...
int SYS13_feature_location_(self__,ci__,f__)
ptr self__;
int ci__;
int f__;
{
