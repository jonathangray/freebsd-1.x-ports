...
ptr LIS204_push_();
int LIS204_size_();
char LIS204_is_empty_();
ptr LIS204_pop_();
ptr LIS204_top_();
LIS204_init_iterate_();
ptr LIS204_curr_item_();
ptr LIS204_next_item_();
ptr LIS204_prev_item_();
ptr LIS204_push_unique_();
ptr LIS204_append_();
ptr LIS204_union_();
char LIS204_not_in_();
int LIS204_contains_();
ptr LIS204_initialize_();
extern int attr_ent_LIS204[];

LIS204_clear_(self__)
ptr self__;
{
   int    i__ = S_int_VOID_;
...
ptr LIS204_create_(self__,init_size__)
ptr self__;
int init_size__;
{
   ptr res__ = 0;
...
ptr LIS204_push_unique_(self__,e__)
ptr self__;
ptr e__;
{
   ptr res__ = 0;
...
ptr LIS204_append_(self__,list__)
ptr self__;
ptr list__;
{
   ptr res__ = 0;
...
ptr LIS204_union_(self__,list__)
ptr self__;
ptr list__;
{
   ptr res__ = 0;
...
char LIS204_not_in_(self__,e__)
ptr self__;
ptr e__;
{
   char res__ = S_char_VOID_;
...
int LIS204_contains_(self__,e__)
ptr self__;
ptr e__;
{
   int res__ = S_int_VOID_;
...
ptr LIS204_initialize_(self__,initarg__)
ptr self__;
ptr initarg__;
{
   ptr res__ = 0;
