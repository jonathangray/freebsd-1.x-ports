...
char DOT81_compile_key_p_();
ptr DOT81_initialize_();
...
DOT81_init_();
char DOT81_found_p_();
char DOT81_read_cmdfile_();
ptr DOT81_ith_source_file_();
extern int attr_ent_DOT81[];

char DOT81_compile_key_p_(self__,i__)
ptr self__;
int i__;
{
...
ptr DOT81_initialize_(self__,initarg__)
ptr self__;
ptr initarg__;
{
   ptr res__ = 0;
...
DOT81_init_(self__,cmdfile_name__)
ptr self__;
ptr cmdfile_name__;
{
...
char DOT81_found_p_(self__,fname__)
ptr self__;
ptr fname__;
{
   char res__ = S_char_VOID_;
...
char DOT81_read_cmdfile_(self__)
ptr self__;
{
   char res__ = S_char_VOID_;
...
ptr DOT81_ith_source_file_(self__,i__)
ptr self__;
int i__;
{
   ptr res__ = 0;
