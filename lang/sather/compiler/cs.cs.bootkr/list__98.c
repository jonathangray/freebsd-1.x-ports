...
ptr LIS98_push_();
int LIS98_size_();
char LIS98_is_empty_();
int LIS98_pop_();
int LIS98_top_();
LIS98_init_iterate_();
int LIS98_curr_item_();
int LIS98_next_item_();
int LIS98_prev_item_();
ptr LIS98_push_unique_();
ptr LIS98_append_();
ptr LIS98_union_();
char LIS98_not_in_();
int LIS98_contains_();
ptr LIS98_initialize_();
...
ptr LIS98_create_(self__,init_size__)
ptr self__;
int init_size__;
{
   ptr res__ = 0;
...
ptr LIS98_push_unique_(self__,e__)
ptr self__;
int e__;
{
   ptr res__ = 0;
...
ptr LIS98_append_(self__,list__)
ptr self__;
ptr list__;
{
   ptr res__ = 0;
...
ptr LIS98_union_(self__,list__)
ptr self__;
ptr list__;
{
   ptr res__ = 0;
...
int LIS98_contains_(self__,e__)
ptr self__;
int e__;
{
   int res__ = S_int_VOID_;
...
ptr LIS98_initialize_(self__,initarg__)
ptr self__;
ptr initarg__;
{
   ptr res__ = 0;
