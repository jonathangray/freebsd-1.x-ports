...
CS_23_error_exit_();
CS_23_warning_msg_();
char CS_23_read_commands_();
CS_23_release_msg_();
CS_23_system_msg_();
char CS_23_read_source_files_();
CS_23_read_code_();
CS_23_process_classdef_();
CS_23_main_init_();
/*shared*/ char CS_23_sdb_inc_compile_warning_;
CS_23_set_options_();
CS_23_setup_dir_();
CS_23_process_classes_();
CS_23_handle_object_files_();
CS_23_print_times_();
int CS_23_main_();
ptr CS_23_initialize_();
extern int attr_ent_CS_23[];

CS_23_error_msg_(self__,s__)
ptr self__;
ptr s__;
{
...
char CS_23_read_commands_(self__)
ptr self__;
{
...
char CS_23_read_source_files_(self__)
ptr self__;
{
   char res__ = S_char_VOID_;
   SATHER_STR_(20,19,ls1253_,"Error in opening \"");
...
CS_23_process_classdef_(self__,def__)
ptr self__;
ptr def__;
{
...
ptr CS_23_initialize_(self__,initarg__)
ptr self__;
ptr initarg__;
{
   ptr res__ = 0;
