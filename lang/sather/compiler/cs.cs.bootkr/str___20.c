...
ptr STR20_d_();
ptr STR20_nl_();
char STR20_is_equal_();
char STR20_is_less_than_();
ptr STR20_to_upper_case_();
ptr STR20_to_lower_case_();
ptr STR20_capitalize_();
char STR20_is_upper_case_();
ptr STR20_head_();
ptr STR20_tail_();
int STR20_length_();
ptr STR20_substring_();
int STR20_index_of_char_();
ptr STR20_reverse_();
char STR20_is_empty_();
int STR20_to_i_();
float STR20_to_r_();
double STR20_to_d_();
char STR20_to_b_();
char STR20_to_c_();
ptr STR20_from_c_str_();
ptr STR20_cursor_();
int STR20_hash_();
...
ptr STR20_create_sized_(self__,n__)
ptr self__;
int n__;
{
   ptr res__ = 0;
...
char STR20_is_equal_(self__,st__)
ptr self__;
ptr st__;
{
...
char STR20_is_less_than_(self__,st__)
ptr self__;
ptr st__;
{
   char res__ = S_char_VOID_;
...
ptr STR20_to_upper_case_(self__)
ptr self__;
{
   ptr res__ = 0;
   int    i__ = S_int_VOID_;
...
ptr STR20_to_lower_case_(self__)
ptr self__;
{
   ptr res__ = 0;
   int    i__ = S_int_VOID_;
...
char STR20_is_upper_case_(self__)
ptr self__;
{
   char res__ = S_char_VOID_;
   int    i__ = S_int_VOID_;
...
ptr STR20_substring_(self__,n__,m__)
ptr self__;
int n__;
int m__;
{
...
int STR20_index_of_char_(self__,ch__)
ptr self__;
char ch__;
{
   int res__ = S_int_VOID_;
...
ptr STR20_from_c_str_(self__,st__)
ptr self__;
ptr st__;
{
   ptr res__ = 0;
