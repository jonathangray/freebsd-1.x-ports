...
ptr CON58_dup_();
CON58_put_kwdname_();
ptr CON58_sather_code_();
ptr CON58_initialize_();
ptr CON58_pcopy_();
/*constant*/ int CON58_print_indent_ = 2;
ptr CON58_create_();
CON58_out_of_line_();
CON58_mark_private_();
CON58_mark_abstract_();
CON58_mark_spec_();
CON58_mark_shared_();
CON58_mark_readonly_();
ptr CON58_create_lst_();
extern int attr_ent_CON58[];

ptr CON58_dup_(self__)
ptr self__;
{
   ptr res__ = 0;
...
CON58_put_kwdname_(self__,nm__)
ptr self__;
int nm__;
{
   ptr gl868_;
...
ptr CON58_initialize_(self__,initarg__)
ptr self__;
ptr initarg__;
{
   ptr res__ = 0;
...
ptr CON58_pcopy_(self__,pl__,pi__)
ptr self__;
ptr pl__;
ptr pi__;
{
...
ptr CON58_create_(self__,nm__,t__,e__,ln__)
ptr self__;
int nm__;
ptr t__;
ptr e__;
...
CON58_out_of_line_(self__,fn__)
ptr self__;
ptr fn__;
{
...
ptr CON58_create_lst_(self__,do__,exp__)
ptr self__;
ptr do__;
ptr exp__;
{
