...
C_F74_set_st_mtime_();
C_F74_set_st_ctime_();
ptr C_F74_initialize_();
extern int attr_ent_C_F74[];

ptr C_F74_create_(self__)
ptr self__;
{
   ptr res__ = 0;
...
C_F74_set_st_nlink_(self__,x__)
ptr self__;
int x__;
{
...
C_F74_set_st_atime_(self__,x__)
ptr self__;
int x__;
{
...
C_F74_set_st_mtime_(self__,x__)
ptr self__;
int x__;
{
...
C_F74_set_st_ctime_(self__,x__)
ptr self__;
int x__;
{
...
ptr C_F74_initialize_(self__,initarg__)
ptr self__;
ptr initarg__;
{
   ptr res__ = 0;
