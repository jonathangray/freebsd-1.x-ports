...
ptr STR251_create_();
int STR251_str_hash_();
char STR251_is_equal_();
ptr STR251_initialize_();
extern int attr_ent_STR251[];

ptr STR251_create_(self__,ns__,i__,nval__)
ptr self__;
ptr ns__;
int i__;
int nval__;
...
int STR251_str_hash_(self__,st__,i__)
ptr self__;
ptr st__;
int i__;
{
...
char STR251_is_equal_(self__,e__)
ptr self__;
ptr e__;
{
...
ptr STR251_initialize_(self__,initarg__)
ptr self__;
ptr initarg__;
{
   ptr res__ = 0;
