...
ptr GEN255_item_();
ptr GEN255_next_();
ptr GEN255_initialize_();
extern int attr_ent_GEN255[];

ptr GEN255_create_(self__,nt__)
ptr self__;
ptr nt__;
{
   ptr res__ = 0;
...
ptr GEN255_initialize_(self__,initarg__)
ptr self__;
ptr initarg__;
{
   ptr res__ = 0;
