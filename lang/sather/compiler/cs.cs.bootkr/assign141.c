...
ptr ASS141_dup_();
ASS141_put_kwdname_();
ptr ASS141_sather_code_();
ptr ASS141_initialize_();
ASS141_resolve_predef_types_();
ASS141_semant_();
ptr ASS141_typeof_();
int ASS141_get_offset_();
ASS141_cprint_offset_();
ptr ASS141_get_constval_();
ASS141_cont_cprint_code_();
ASS141_cprint_cname_();
ASS141_cprint_extern_();
ASS141_cprint_access_value_();
ASS141_cprint_init_code_();
char ASS141_typechk_exprs_();
ptr ASS141_gen_temps_();
ASS141_gen_goto_tags_();
ASS141_validate_dispatches_and_get_ext_strs_();
ASS141_cprint_code_();
extern int attr_ent_ASS141[];

ptr ASS141_create_(self__,lv__,exp__,ln__)
ptr self__;
ptr lv__;
ptr exp__;
int ln__;
...
ASS141_out_of_line_(self__,fn__)
ptr self__;
ptr fn__;
{
   ptr gl3515_;
...
ASS141_put_kwdname_(self__,nm__)
ptr self__;
int nm__;
{
   ptr gl3527_;
...
ptr ASS141_sather_code_(self__)
ptr self__;
{
   ptr res__ = 0;
...
ptr ASS141_initialize_(self__,initarg__)
ptr self__;
ptr initarg__;
{
   ptr res__ = 0;
...
ASS141_resolve_predef_types_(self__,index__)
ptr self__;
int index__;
{
   ptr gl3530_;
...
ASS141_semant_(self__,symtab__)
ptr self__;
ptr symtab__;
{
...
ASS141_cprint_offset_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
ptr ASS141_get_constval_(self__)
ptr self__;
{
   ptr res__ = 0;
...
ASS141_cont_cprint_code_(self__,outfile__,cont__)
ptr self__;
ptr outfile__;
int cont__;
{
...
ASS141_cprint_cname_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
ASS141_cprint_extern_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
ASS141_cprint_access_value_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
ASS141_cprint_init_code_(self__,outfile__)
ptr self__;
ptr outfile__;
{
...
char ASS141_typechk_exprs_(self__,tp__)
ptr self__;
ptr tp__;
{
...
ASS141_gen_goto_tags_(self__,block__)
ptr self__;
ptr block__;
{
...
ASS141_validate_dispatches_and_get_ext_strs_(self__)
ptr self__;
{
   ptr gl3596_;
   static int gl3597_;
...
ASS141_cprint_code_(self__,outfile__)
ptr self__;
ptr outfile__;
{
