...
int LST147_hash_();
char LST147_is_equal_();
ptr LST147_initialize_();
LST147_clear_();
/*constant*/ int LST147_def_init_size_ = 5;
ptr LST147_create_();
ptr LST147_push_();
int LST147_size_();
char LST147_is_empty_();
int LST147_pop_();
int LST147_top_();
LST147_init_iterate_();
int LST147_curr_item_();
int LST147_next_item_();
int LST147_prev_item_();
ptr LST147_push_unique_();
ptr LST147_append_();
ptr LST147_union_();
char LST147_not_in_();
int LST147_contains_();
LST147_key_print_();
extern int attr_ent_LST147[];

int LST147_hash_(self__,max__)
ptr self__;
int max__;
{
...
char LST147_is_equal_(self__,k__)
ptr self__;
ptr k__;
{
...
ptr LST147_initialize_(self__,initarg__)
ptr self__;
ptr initarg__;
{
   ptr res__ = 0;
...
ptr LST147_create_(self__,init_size__)
ptr self__;
int init_size__;
{
   ptr res__ = 0;
...
ptr LST147_push_unique_(self__,e__)
ptr self__;
int e__;
{
   ptr res__ = 0;
...
ptr LST147_append_(self__,list__)
ptr self__;
ptr list__;
{
   ptr res__ = 0;
...
ptr LST147_union_(self__,list__)
ptr self__;
ptr list__;
{
   ptr res__ = 0;
...
char LST147_not_in_(self__,e__)
ptr self__;
int e__;
{
   char res__ = S_char_VOID_;
...
int LST147_contains_(self__,e__)
ptr self__;
int e__;
{
   int res__ = S_int_VOID_;
...
LST147_key_print_(self__,outfile__)
ptr self__;
ptr outfile__;
{
   int    i__ = S_int_VOID_;
