...
ptr TYP114_dup_();
TYP114_put_kwdname_();
ptr TYP114_sather_code_();
ptr TYP114_initialize_();
ptr TYP114_pcopy_();
...
char TYP114_base_classname_p_();
ptr TYP114_disp_type_();
ptr TYP114_name_str_();
ptr TYP114_get_key_();
extern int attr_ent_TYP114[];

ptr TYP114_create_(self__)
ptr self__;
{
   ptr res__ = 0;
...
TYP114_out_of_line_(self__,fn__)
ptr self__;
ptr fn__;
{
...
TYP114_put_kwdname_(self__,nm__)
ptr self__;
int nm__;
{
   ptr gl2676_;
...
ptr TYP114_sather_code_(self__)
ptr self__;
{
   ptr res__ = 0;
...
ptr TYP114_initialize_(self__,initarg__)
ptr self__;
ptr initarg__;
{
   ptr res__ = 0;
...
ptr TYP114_pcopy_(self__,pl__,pi__)
ptr self__;
ptr pl__;
ptr pi__;
{
...
char TYP114_base_classname_p_(self__,i__)
ptr self__;
int i__;
{
...
ptr TYP114_get_key_(self__,pl__,pi__)
ptr self__;
ptr pl__;
ptr pi__;
{
