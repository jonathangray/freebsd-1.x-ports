...
ptr LST40_dup_();
LST40_put_kwdname_();
ptr LST40_sather_code_();
ptr LST40_initialize_();
ptr LST40_pcopy_();
LST40_clear_();
/*constant*/ int LST40_def_init_size_ = 5;
ptr LST40_push_();
int LST40_size_();
char LST40_is_empty_();
ptr LST40_pop_();
ptr LST40_top_();
LST40_init_iterate_();
ptr LST40_curr_item_();
ptr LST40_next_item_();
ptr LST40_prev_item_();
ptr LST40_push_unique_();
ptr LST40_append_();
ptr LST40_union_();
char LST40_not_in_();
int LST40_contains_();
...
ptr LST40_create_(self__,init_size__)
ptr self__;
int init_size__;
{
   ptr res__ = 0;
...
LST40_out_of_line_(self__,fn__)
ptr self__;
ptr fn__;
{
...
LST40_put_kwdname_(self__,nm__)
ptr self__;
int nm__;
{
   ptr gl636_;
...
ptr LST40_initialize_(self__,initarg__)
ptr self__;
ptr initarg__;
{
   ptr res__ = 0;
...
ptr LST40_pcopy_(self__,pl__,pi__)
ptr self__;
ptr pl__;
ptr pi__;
{
...
ptr LST40_push_unique_(self__,e__)
ptr self__;
ptr e__;
{
   ptr res__ = 0;
...
ptr LST40_append_(self__,list__)
ptr self__;
ptr list__;
{
   ptr res__ = 0;
...
ptr LST40_union_(self__,list__)
ptr self__;
ptr list__;
{
   ptr res__ = 0;
...
int LST40_contains_(self__,e__)
ptr self__;
ptr e__;
{
   int res__ = S_int_VOID_;
