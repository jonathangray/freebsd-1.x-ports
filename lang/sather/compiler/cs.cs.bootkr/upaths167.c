...
ptr UPA167_env_v_val_();
ptr UPA167_canonicalize_();
/*shared*/ ptr UPA167_automount_name_;
ptr UPA167_strip_automount_name_();
ptr UPA167_patronize_();
ptr UPA167_filename_();
ptr UPA167_dirname_();
ptr UPA167_suffix_();
ptr UPA167_filename_sans_();
ptr UPA167_concat_();
ptr UPA167_initialize_();
extern int attr_ent_UPA167[];

ptr UPA167_env_v_val_(self__,st__)
ptr self__;
ptr st__;
{
   ptr res__ = 0;
...
ptr UPA167_canonicalize_(self__,st__)
ptr self__;
ptr st__;
{
   ptr res__ = 0;
...
ptr UPA167_strip_automount_name_(self__,st__)
ptr self__;
ptr st__;
{
   ptr res__ = 0;
...
ptr UPA167_patronize_(self__,st__,len_st__,wd__,len_wd__)
ptr self__;
ptr st__;
int len_st__;
ptr wd__;
...
ptr UPA167_filename_(self__,st__)
ptr self__;
ptr st__;
{
   ptr res__ = 0;
...
ptr UPA167_dirname_(self__,st__)
ptr self__;
ptr st__;
{
   ptr res__ = 0;
...
ptr UPA167_suffix_(self__,st__)
ptr self__;
ptr st__;
{
   ptr res__ = 0;
...
ptr UPA167_filename_sans_(self__,st__)
ptr self__;
ptr st__;
{
   ptr res__ = 0;
...
ptr UPA167_concat_(self__,p1__,p2__)
ptr self__;
ptr p1__;
ptr p2__;
{
...
ptr UPA167_initialize_(self__,initarg__)
ptr self__;
ptr initarg__;
{
   ptr res__ = 0;
