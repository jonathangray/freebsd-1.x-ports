...
ptr ASS50_dup_();
ASS50_put_kwdname_();
ptr ASS50_sather_code_();
ptr ASS50_initialize_();
ptr ASS50_pcopy_();
extern int attr_ent_ASS50[];

ptr ASS50_create_(self__,lv__,exp__,ln__)
ptr self__;
ptr lv__;
ptr exp__;
int ln__;
...
ASS50_out_of_line_(self__,fn__)
ptr self__;
ptr fn__;
{
...
ASS50_put_kwdname_(self__,nm__)
ptr self__;
int nm__;
{
   ptr gl780_;
...
ptr ASS50_initialize_(self__,initarg__)
ptr self__;
ptr initarg__;
{
   ptr res__ = 0;
...
ptr ASS50_pcopy_(self__,pl__,pi__)
ptr self__;
ptr pl__;
ptr pi__;
{
