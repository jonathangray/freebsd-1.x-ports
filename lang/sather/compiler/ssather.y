 ...
 *
 * $Id: ssather.y,v 1.1 1994/02/12 03:21:47 hsu Exp $
 *
 * HISTORY: 
 ** Last edited: Oct 31 17:18 1993 (hws)
 **  Oct 31 14:10 1993 (hws): optional/ignored type bounds and "arg" for 1.0 bootstrap
...
%type <val> alias_dec alias_list statement_list statement typid
...
class: CLASS TYPID getlnno opt_type_vars IS feature_list END
   ...
   | CLASS TYPID getlnno opt_type_vars '<' type_spec_list '>' type_spec_list IS feature_list END
    { main_process_classdef(0, classob_create(NULL,$2,$3,$4,$10,NULL)); }
   ...
   | ABSTRACT CLASS '$' TYPID getlnno opt_type_vars '<' type_spec_list '>' type_spec_list IS feature_list END
    { main_process_classdef(0, classob_create(NULL,$4,$5,$6,$12,1)); }
...
typid_list: typid			         /* Comma separated fromal types */
    { $$ = (ptr)lst_int_push(lst_int_create(NULL,5),$1); }
  | typid_list ',' typid
    { $$ = (ptr)lst_int_push($1,$3); }
;

typid: TYPID			         /* optionally bounded type id */
    { $$ = (ptr)$1; }
  | TYPID '<' type_spec			 /* type bound ignored */
    { $$ = (ptr)$1; }
;
...
single_var_dec: IDENTIFIER ':' type_spec
  ...
  | TYPID ':' type_spec			/* C shared must allow uppercase */
    { $$ = (ptr)any_declob_create(NULL,
			       lst_int_push(lst_int_create(NULL,1),$1),
			       $3); }
/* optional "arg", without the ':' creates a reduce/reduce conflict. */
/*  | ':' type_spec
    { $$ = (ptr)any_declob_create(NULL,
				  lst_int_push(lst_int_create(NULL,1),ARG_IND),
				  $2); }
*/
;
...
var_dec_list: var_dec		/* One declaration */
  ...
  /* Allow commas instead of semicolons */
  | var_dec_list ','		/* Extra semi-colon */
    { $$ = (ptr)$1; }
  | var_dec_list ',' var_dec	/* Several declarations */
    { $$ = (ptr)lst_declob_append($1,param_declob_create_lst(NULL,$3)); }
