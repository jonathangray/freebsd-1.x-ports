...
ptr CLA66_create_(ptr self__, int size__);
int CLA66_hash_(ptr self__, int nm__);
ptr CLA66_get_obj_(ptr self__, int nm__);
char CLA66_add_obj_(ptr self__, int nm__, ptr ob__);
void CLA66_add_unique_obj_(ptr self__, int nm__, ptr ob__);
void CLA66_double_tables_(ptr self__);
char CLA66_remove_obj_(ptr self__, int nm__);
ptr CLA66_initialize_(ptr self__, ptr initarg__);
...
char CLA66_base_classname_p_(ptr self__, int i__);
void CLA66_uppercase_name_p_(ptr self__, ptr def__);
void CLA66_install_(ptr self__, ptr new_def__);
ptr CLA66_at_index_(ptr self__, int i__);
void CLA66_print_table_(ptr self__, ptr outfile__);
void CLA66_print_def_(ptr self__, ptr outfile__, ptr cnm__);
