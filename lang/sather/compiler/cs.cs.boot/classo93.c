...
ptr CLA93_initialize_(ptr self__, ptr initarg__);
...
char CLA93_base_classname_p_(ptr self__, int i__);
/*constant*/ int CLA93_def_table_size_ = 50;
void CLA93_error_msg_(ptr self__, ptr s__);
void CLA93_error_exit_(ptr self__, ptr s__);
void CLA93_expand_(ptr self__, int size__);
ptr CLA93_create_(ptr self__, int size__);
int CLA93_hash_(ptr self__, ptr k__);
ptr CLA93_get_obj_(ptr self__, ptr k__);
void CLA93_add_unique_obj_(ptr self__, ptr k__, ptr inst__);
void CLA93_add_unique_obj_at_(ptr self__, ptr k__, ptr inst__, int loc__);
void CLA93_double_tables_(ptr self__);
char CLA93_remove_obj_(ptr self__, ptr k__);
ptr CLA93_at_index_(ptr self__, int i__);
void CLA93_print_table_(ptr self__, ptr outfile__);
