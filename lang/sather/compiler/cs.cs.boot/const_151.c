...
int CON151_get_offset_(ptr self__);
void CON151_cprint_offset_(ptr self__, ptr outfile__);
ptr CON151_get_constval_(ptr self__);
void CON151_cont_cprint_code_(ptr self__, ptr outfile__, int cont__);
void CON151_cprint_cname_(ptr self__, ptr outfile__);
void CON151_cprint_extern_(ptr self__, ptr outfile__);
void CON151_cprint_access_value_(ptr self__, ptr outfile__);
void CON151_cprint_init_code_(ptr self__, ptr outfile__);
/*constant*/ int CON151_print_indent_ = 2;
ptr CON151_create_(ptr self__, int nm__, ptr t__, ptr e__, char priv__, ptr c_def__, int ln__);
void CON151_out_of_line_(ptr self__, ptr fn__);
ptr CON151_dup_(ptr self__);
void CON151_put_kwdname_(ptr self__, int nm__);
ptr CON151_sather_code_(ptr self__);
int CON151_class_inst_ind_(ptr self__);
int CON151_featob_s_name_(ptr self__);
void CON151_mark_private_(ptr self__);
void CON151_mark_abstract_(ptr self__);
void CON151_mark_spec_(ptr self__);
void CON151_mark_shared_(ptr self__);
void CON151_mark_readonly_(ptr self__);
char CON151_undefined_p_(ptr self__);
int CON151_compute_own_offset_(ptr self__, int nextloc__);
void CON151_eval_constant_(ptr self__);
ptr CON151_rettype_(ptr self__);
void CON151_remember_local_(ptr self__, ptr lvar__);
void CON151_semant_prologue_(ptr self__);
void CON151_do_gen_temps_(ptr self__);
void CON151_gen_goto_tags_(ptr self__);
void CON151_validate_dispatches_and_get_ext_strs_(ptr self__);
char CON151_compatible_des_feat_(ptr self__, ptr feat__, char lval_p__);
void CON151_update_used_in_dispatch_(ptr self__);
void CON151_consistent_defs_(ptr self__, int nm__, char lval_p__);
void CON151_cprint_decln_(ptr self__, ptr outfile__);
void CON151_cprint_routine_(ptr self__, ptr outfile__);
void CON151_cprint_store_dispval_(ptr self__, ptr outfile__);
int CON151_declob_s_name_(ptr self__);
void CON151_cprint_code_(ptr self__, ptr outfile__);
ptr CON151_initialize_(ptr self__, ptr initarg__);
void CON151_resolve_predef_types_(ptr self__, int index__);
void CON151_semant_(ptr self__, ptr symtab__);
ptr CON151_typeof_(ptr self__);
int CON151_is_a_str_const_(ptr self__);
void CON151_cprint_decln_with_poss_init_(ptr self__, ptr outfile__);
