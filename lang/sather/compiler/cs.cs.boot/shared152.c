...
ptr SHA152_typeof_(ptr self__);
int SHA152_get_offset_(ptr self__);
void SHA152_cprint_offset_(ptr self__, ptr outfile__);
ptr SHA152_get_constval_(ptr self__);
void SHA152_cont_cprint_code_(ptr self__, ptr outfile__, int cont__);
void SHA152_cprint_cname_(ptr self__, ptr outfile__);
void SHA152_cprint_extern_(ptr self__, ptr outfile__);
void SHA152_cprint_access_value_(ptr self__, ptr outfile__);
void SHA152_cprint_init_code_(ptr self__, ptr outfile__);
/*constant*/ int SHA152_print_indent_ = 2;
ptr SHA152_create_(ptr self__, int nm__, ptr t__, ptr e__, char priv__, ptr c_def__, int ln__);
void SHA152_out_of_line_(ptr self__, ptr fn__);
ptr SHA152_dup_(ptr self__);
void SHA152_put_kwdname_(ptr self__, int nm__);
ptr SHA152_sather_code_(ptr self__);
int SHA152_class_inst_ind_(ptr self__);
int SHA152_featob_s_name_(ptr self__);
void SHA152_mark_private_(ptr self__);
void SHA152_mark_abstract_(ptr self__);
void SHA152_mark_spec_(ptr self__);
void SHA152_mark_shared_(ptr self__);
void SHA152_mark_readonly_(ptr self__);
char SHA152_undefined_p_(ptr self__);
int SHA152_compute_own_offset_(ptr self__, int nextloc__);
void SHA152_eval_constant_(ptr self__);
ptr SHA152_rettype_(ptr self__);
void SHA152_remember_local_(ptr self__, ptr lvar__);
void SHA152_semant_prologue_(ptr self__);
void SHA152_do_gen_temps_(ptr self__);
void SHA152_gen_goto_tags_(ptr self__);
void SHA152_validate_dispatches_and_get_ext_strs_(ptr self__);
char SHA152_compatible_des_feat_(ptr self__, ptr feat__, char lval_p__);
void SHA152_update_used_in_dispatch_(ptr self__);
void SHA152_consistent_defs_(ptr self__, int nm__, char lval_p__);
void SHA152_cprint_decln_(ptr self__, ptr outfile__);
void SHA152_cprint_routine_(ptr self__, ptr outfile__);
void SHA152_cprint_store_dispval_(ptr self__, ptr outfile__);
int SHA152_declob_s_name_(ptr self__);
void SHA152_cprint_code_(ptr self__, ptr outfile__);
ptr SHA152_initialize_(ptr self__, ptr initarg__);
void SHA152_resolve_predef_types_(ptr self__, int index__);
void SHA152_semant_(ptr self__, ptr symtab__);
