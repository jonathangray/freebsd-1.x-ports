...
ptr PAR57_create_(ptr self__, int nm__, ptr p__);
void PAR57_out_of_line_(ptr self__, ptr fn__);
ptr PAR57_dup_(ptr self__);
void PAR57_put_kwdname_(ptr self__, int nm__);
ptr PAR57_sather_code_(ptr self__);
ptr PAR57_initialize_(ptr self__, ptr initarg__);
ptr PAR57_pcopy_(ptr self__, ptr pl__, ptr pi__);
...
char PAR57_base_classname_p_(ptr self__, int i__);
ptr PAR57_disp_type_(ptr self__);
ptr PAR57_name_str_(ptr self__);
ptr PAR57_get_key_(ptr self__, ptr pl__, ptr pi__);
char PAR57_install_param_inst_(ptr self__, ptr k__, ptr pinst__);
