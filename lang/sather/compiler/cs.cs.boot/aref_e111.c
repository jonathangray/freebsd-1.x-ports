...
ptr ARE111_create_(ptr self__, ptr arr__, ptr inds__, int ln__);
void ARE111_out_of_line_(ptr self__, ptr fn__);
ptr ARE111_dup_(ptr self__);
void ARE111_put_kwdname_(ptr self__, int nm__);
ptr ARE111_sather_code_(ptr self__);
ptr ARE111_initialize_(ptr self__, ptr initarg__);
void ARE111_resolve_predef_types_(ptr self__, int index__);
void ARE111_semant_(ptr self__, ptr symtab__);
ptr ARE111_typeof_(ptr self__);
int ARE111_get_offset_(ptr self__);
void ARE111_cprint_offset_(ptr self__, ptr outfile__);
ptr ARE111_get_constval_(ptr self__);
void ARE111_cont_cprint_code_(ptr self__, ptr outfile__, int cont__);
void ARE111_cprint_cname_(ptr self__, ptr outfile__);
void ARE111_cprint_extern_(ptr self__, ptr outfile__);
void ARE111_cprint_access_value_(ptr self__, ptr outfile__);
void ARE111_cprint_init_code_(ptr self__, ptr outfile__);
char ARE111_valid_init_expr_(ptr self__);
char ARE111_assignable_p_(ptr self__);
ptr ARE111_gen_temps_(ptr self__);
ptr ARE111_expr_eval_constant_(ptr self__);
void ARE111_get_ext_strs_(ptr self__);
char ARE111_to_be_pre_evaluated_(ptr self__);
char ARE111_access_value_only_(ptr self__);
void ARE111_fob_error_(ptr self__, ptr op_name__, ptr cls_name__);
void ARE111_cprint_pre_code_(ptr self__, ptr outfile__);
void ARE111_cprint_act_code_(ptr self__, ptr outfile__);
void ARE111_cprint_cast_code_(ptr self__, ptr outfile__);
void ARE111_cprint_ith_index_pre_code_(ptr self__, int i__, ptr outfile__);
void ARE111_cprint_ith_index_act_code_(ptr self__, int i__, ptr outfile__);
...
void ARE111_cprint_index_(ptr self__, int i__, int sz__, ptr outfile__);
