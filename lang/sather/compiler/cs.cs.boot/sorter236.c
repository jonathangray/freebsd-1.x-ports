...
void SOR236_qsortdoit_(ptr self__, int l__, int u__);
void SOR236_qsort_(ptr self__, ptr arr__, int u__, int l__);
ptr SOR236_initialize_(ptr self__, ptr initarg__);
