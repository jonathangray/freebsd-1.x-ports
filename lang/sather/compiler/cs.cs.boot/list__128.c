...
void LIS128_clear_(ptr self__);
/*constant*/ int LIS128_def_init_size_ = 5;
ptr LIS128_create_(ptr self__, int init_size__);
ptr LIS128_push_(ptr self__, ptr e__);
int LIS128_size_(ptr self__);
char LIS128_is_empty_(ptr self__);
ptr LIS128_pop_(ptr self__);
ptr LIS128_top_(ptr self__);
void LIS128_init_iterate_(ptr self__);
ptr LIS128_curr_item_(ptr self__);
ptr LIS128_next_item_(ptr self__);
ptr LIS128_prev_item_(ptr self__);
ptr LIS128_push_unique_(ptr self__, ptr e__);
ptr LIS128_append_(ptr self__, ptr list__);
ptr LIS128_union_(ptr self__, ptr list__);
char LIS128_not_in_(ptr self__, ptr e__);
int LIS128_contains_(ptr self__, ptr e__);
ptr LIS128_initialize_(ptr self__, ptr initarg__);
