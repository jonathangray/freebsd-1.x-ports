...
void GEN83_error_msg_(ptr self__, ptr s__);
void GEN83_error_exit_(ptr self__, ptr s__);
void GEN83_start_(ptr self__, ptr nm__);
void GEN83_terminate_(ptr self__);
ptr GEN83_cmacro_def_(ptr self__, int i__);
void GEN83_insert_(ptr self__, ptr nm__);
ptr GEN83_create_(ptr self__);
int GEN83_info_size_(ptr self__);
ptr GEN83_ith_str_(ptr self__, int i__);
ptr GEN83_ith_info_(ptr self__, int i__);
void GEN83_cprint_self_(ptr self__, ptr outfile__);
ptr GEN83_initialize_(ptr self__, ptr initarg__);
