...
void ROU156_resolve_predef_types_(ptr self__, int index__);
void ROU156_semant_(ptr self__, ptr symtab__);
ptr ROU156_typeof_(ptr self__);
int ROU156_get_offset_(ptr self__);
void ROU156_cprint_offset_(ptr self__, ptr outfile__);
ptr ROU156_get_constval_(ptr self__);
void ROU156_cont_cprint_code_(ptr self__, ptr outfile__, int cont__);
void ROU156_cprint_cname_(ptr self__, ptr outfile__);
void ROU156_cprint_extern_(ptr self__, ptr outfile__);
void ROU156_cprint_access_value_(ptr self__, ptr outfile__);
void ROU156_cprint_init_code_(ptr self__, ptr outfile__);
/*constant*/ int ROU156_print_indent_ = 2;
ptr ROU156_create_(ptr self__, int nm__, ptr precond__, ptr postcond__, ptr o__, ptr pl__, ptr rt__, ptr sl__, char priv__, ptr c_def__, int ln__, int eln__);
void ROU156_out_of_line_(ptr self__, ptr fn__);
ptr ROU156_dup_(ptr self__);
void ROU156_put_kwdname_(ptr self__, int nm__);
ptr ROU156_sather_code_(ptr self__);
int ROU156_class_inst_ind_(ptr self__);
int ROU156_featob_s_name_(ptr self__);
void ROU156_mark_private_(ptr self__);
void ROU156_mark_abstract_(ptr self__);
void ROU156_mark_spec_(ptr self__);
void ROU156_mark_shared_(ptr self__);
void ROU156_mark_readonly_(ptr self__);
char ROU156_undefined_p_(ptr self__);
int ROU156_compute_own_offset_(ptr self__, int nextloc__);
void ROU156_eval_constant_(ptr self__);
ptr ROU156_rettype_(ptr self__);
void ROU156_remember_local_(ptr self__, ptr lvar__);
void ROU156_semant_prologue_(ptr self__);
void ROU156_do_gen_temps_(ptr self__);
void ROU156_gen_goto_tags_(ptr self__);
void ROU156_validate_dispatches_and_get_ext_strs_(ptr self__);
char ROU156_compatible_des_feat_(ptr self__, ptr feat__, char lval_p__);
void ROU156_update_used_in_dispatch_(ptr self__);
void ROU156_consistent_defs_(ptr self__, int nm__, char lval_p__);
void ROU156_cprint_decln_(ptr self__, ptr outfile__);
void ROU156_cprint_routine_(ptr self__, ptr outfile__);
void ROU156_cprint_store_dispval_(ptr self__, ptr outfile__);
ptr ROU156_initialize_(ptr self__, ptr initarg__);
char ROU156_param_conforms_to_(ptr self__, ptr par__, ptr ch__);
void ROU156_add_str_const_(ptr self__, ptr str_const__);
void ROU156_cprint_rtcode_(ptr self__, ptr outfile__);
void ROU156_cprint_post_rtcode_(ptr self__, ptr outfile__);
