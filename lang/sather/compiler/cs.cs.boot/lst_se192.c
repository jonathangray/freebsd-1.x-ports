...
ptr LST192_create_(ptr self__, int init_size__);
void LST192_out_of_line_(ptr self__, ptr fn__);
ptr LST192_dup_(ptr self__);
void LST192_put_kwdname_(ptr self__, int nm__);
ptr LST192_sather_code_(ptr self__);
ptr LST192_initialize_(ptr self__, ptr initarg__);
void LST192_resolve_predef_types_(ptr self__, int index__);
void LST192_semant_(ptr self__, ptr symtab__);
ptr LST192_typeof_(ptr self__);
int LST192_get_offset_(ptr self__);
void LST192_cprint_offset_(ptr self__, ptr outfile__);
ptr LST192_get_constval_(ptr self__);
void LST192_cont_cprint_code_(ptr self__, ptr outfile__, int cont__);
void LST192_cprint_cname_(ptr self__, ptr outfile__);
void LST192_cprint_extern_(ptr self__, ptr outfile__);
void LST192_cprint_access_value_(ptr self__, ptr outfile__);
void LST192_cprint_init_code_(ptr self__, ptr outfile__);
void LST192_clear_(ptr self__);
/*constant*/ int LST192_def_init_size_ = 5;
ptr LST192_push_(ptr self__, ptr e__);
int LST192_size_(ptr self__);
char LST192_is_empty_(ptr self__);
ptr LST192_pop_(ptr self__);
ptr LST192_top_(ptr self__);
void LST192_init_iterate_(ptr self__);
ptr LST192_curr_item_(ptr self__);
ptr LST192_next_item_(ptr self__);
ptr LST192_prev_item_(ptr self__);
ptr LST192_push_unique_(ptr self__, ptr e__);
ptr LST192_append_(ptr self__, ptr list__);
ptr LST192_union_(ptr self__, ptr list__);
char LST192_not_in_(ptr self__, ptr e__);
int LST192_contains_(ptr self__, ptr e__);
void LST192_cprint_code_(ptr self__, ptr outfile__);
