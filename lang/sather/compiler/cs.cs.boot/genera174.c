...
ptr GEN174_create_(ptr self__);
ptr GEN174_get_(ptr self__, ptr e__);
char GEN174_test_(ptr self__, ptr e__);
void GEN174_double_size_(ptr self__);
void GEN174_insert_(ptr self__, ptr e__);
void GEN174_delete_(ptr self__, ptr e__);
void GEN174_clear_(ptr self__);
ptr GEN174_cursor_(ptr self__);
char GEN174_is_empty_(ptr self__);
ptr GEN174_union_(ptr self__, ptr s__);
ptr GEN174_intersection_(ptr self__, ptr s__);
ptr GEN174_difference_(ptr self__, ptr s__);
ptr GEN174_sym_difference_(ptr self__, ptr s__);
char GEN174_is_a_subset_of_(ptr self__, ptr s__);
ptr GEN174_initialize_(ptr self__, ptr initarg__);
