...
ptr LST41_create_(ptr self__, int init_size__);
void LST41_out_of_line_(ptr self__, ptr fn__);
ptr LST41_dup_(ptr self__);
void LST41_put_kwdname_(ptr self__, int nm__);
ptr LST41_sather_code_(ptr self__);
ptr LST41_initialize_(ptr self__, ptr initarg__);
ptr LST41_pcopy_(ptr self__, ptr pl__, ptr pi__);
void LST41_clear_(ptr self__);
/*constant*/ int LST41_def_init_size_ = 5;
ptr LST41_push_(ptr self__, ptr e__);
int LST41_size_(ptr self__);
char LST41_is_empty_(ptr self__);
ptr LST41_pop_(ptr self__);
ptr LST41_top_(ptr self__);
void LST41_init_iterate_(ptr self__);
ptr LST41_curr_item_(ptr self__);
ptr LST41_next_item_(ptr self__);
ptr LST41_prev_item_(ptr self__);
ptr LST41_push_unique_(ptr self__, ptr e__);
ptr LST41_append_(ptr self__, ptr list__);
ptr LST41_union_(ptr self__, ptr list__);
char LST41_not_in_(ptr self__, ptr e__);
int LST41_contains_(ptr self__, ptr e__);
