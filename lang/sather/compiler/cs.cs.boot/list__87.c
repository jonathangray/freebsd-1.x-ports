...
void LIS87_clear_(ptr self__);
/*constant*/ int LIS87_def_init_size_ = 5;
ptr LIS87_create_(ptr self__, int init_size__);
ptr LIS87_push_(ptr self__, ptr e__);
int LIS87_size_(ptr self__);
char LIS87_is_empty_(ptr self__);
ptr LIS87_pop_(ptr self__);
ptr LIS87_top_(ptr self__);
void LIS87_init_iterate_(ptr self__);
ptr LIS87_curr_item_(ptr self__);
ptr LIS87_next_item_(ptr self__);
ptr LIS87_prev_item_(ptr self__);
ptr LIS87_push_unique_(ptr self__, ptr e__);
ptr LIS87_append_(ptr self__, ptr list__);
ptr LIS87_union_(ptr self__, ptr list__);
char LIS87_not_in_(ptr self__, ptr e__);
int LIS87_contains_(ptr self__, ptr e__);
ptr LIS87_initialize_(ptr self__, ptr initarg__);
