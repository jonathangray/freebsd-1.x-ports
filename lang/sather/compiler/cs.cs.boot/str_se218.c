...
void STR218_clear_(ptr self__);
/*shared*/ ptr STR218_del_key_;
ptr STR218_create_(ptr self__);
int STR218_hash_(ptr self__, ptr s__);
char STR218_get_(ptr self__, ptr o__);
ptr STR218_double_size_(ptr self__);
ptr STR218_insert_(ptr self__, ptr o__);
void STR218_delete_(ptr self__, ptr o__);
int STR218_size_(ptr self__);
ptr STR218_cursor_(ptr self__);
ptr STR218_union_(ptr self__, ptr s__);
ptr STR218_intersection_(ptr self__, ptr s__);
ptr STR218_difference_(ptr self__, ptr s__);
ptr STR218_sym_difference_(ptr self__, ptr s__);
ptr STR218_initialize_(ptr self__, ptr initarg__);
