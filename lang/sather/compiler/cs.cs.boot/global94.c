...
int GLO94_global_key_(ptr self__);
void GLO94_reset_global_key_(ptr self__);
...
ptr GLO94_initialize_(ptr self__, ptr initarg__);
int GLO94_featname_from_key_(ptr self__, int k__);
int GLO94_classind_from_key_(ptr self__, int k__);
int GLO94_key_of_class_feat_(ptr self__, int cnm__, int feat__);
int GLO94_help_insert_(ptr self__, int cnm__, int feat__);
char GLO94_check_is_on_(ptr self__);
char GLO94_handle_class_p_(ptr self__, ptr co__);
char GLO94_handle_feature_p_(ptr self__, ptr f__);
char GLO94_is_clib_option_(ptr self__, ptr s__);
char GLO94_conform_tst_(ptr self__, ptr c1__, ptr c2__, ptr exp__);
void GLO94_add_str_const_(ptr self__, ptr str_const__);
void GLO94_remove_user_cfile_(ptr self__, ptr fn__, ptr outfile__);
void GLO94_copy_user_cfile_(ptr self__, ptr fn__, ptr outfile__);
void GLO94_system_(ptr self__, ptr com__);
void GLO94_check_f_ob_(ptr self__, ptr exp__, int name__, ptr symtab__);
ptr GLO94_ctype_name_(ptr self__, int ctype__);
void GLO94_cprint_ctype_name_(ptr self__, int ctype__, ptr outfile__);
void GLO94_cprint_ctemp_name_(ptr self__, int intval__, ptr outfile__);
void GLO94_cprint_global_tmpnm_str_(ptr self__, int strval__, ptr outfile__);
void GLO94_cprint_local_tmpnm_str_(ptr self__, int strval__, ptr outfile__);
void GLO94_cprint_sather_str_type_(ptr self__, ptr outfile__);
void GLO94_cprint_curr_exp_code_(ptr self__, ptr exp__, int temp_nm__, ptr outfile__);
void GLO94_cprint_goto_tag_(ptr self__, int i__, ptr outfile__);
char GLO94_cprint_ref_to_self_(ptr self__, ptr outfile__);
void GLO94_cprint_octal_char_(ptr self__, int v__, ptr outfile__);
void GLO94_cprint_int_as_char_seq_(ptr self__, int v__, ptr outfile__);
ptr GLO94_union_classnames_(ptr self__, ptr l1__, ptr l2__);
ptr GLO94_extract_simple_classnames_(ptr self__, ptr str__, int start_index__);
ptr GLO94_analyze_class_name_(ptr self__, ptr str__, int start_index__);
ptr GLO94_extract_poss_names_(ptr self__, ptr s__);
ptr GLO94_extract_filename_(ptr self__, ptr fullname__);
int GLO94_check_des_of_(ptr self__, int ici__, int l__, int u__);
ptr GLO94_octal_(ptr self__, int i__);
ptr GLO94_ob_ob_(ptr self__, ptr ob__);
