...
ptr CLA166_create_(ptr self__, int sz__);
void CLA166_insert_(ptr self__, int ci__, int k__);
void CLA166_display_(ptr self__);
char CLA166_exists_(ptr self__, int ci__, int k__);
void CLA166_clear_(ptr self__);
ptr CLA166_initialize_(ptr self__, ptr initarg__);
