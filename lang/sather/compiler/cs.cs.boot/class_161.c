...
ptr CLA161_create_(ptr self__, ptr fname__);
ptr CLA161_alloc_create_(ptr self__);
void CLA161_display_(ptr self__, ptr f__);
void CLA161_display_strings_(ptr self__, ptr f__);
void CLA161_persist_(ptr self__, ptr fname__);
int CLA161_get_ind_(ptr self__, ptr cn__);
int CLA161_get_cfile_time_(ptr self__, ptr fn__);
void CLA161_mark_relevant_(ptr self__, ptr co__);
ptr CLA161_irrelevant_classes_(ptr self__);
ptr CLA161_irrelevant_cfiles_(ptr self__);
void CLA161_clear_(ptr self__);
void CLA161_record_mapping_(ptr self__, ptr fn__, int index__);
ptr CLA161_record_new_cfiles_(ptr self__, ptr cfiles__);
void CLA161_record_class_stat_(ptr self__, ptr co__);
void CLA161_record_curr_compilation_(ptr self__);
ptr CLA161_at_index_(ptr self__, int i__);
ptr CLA161_initialize_(ptr self__, ptr initarg__);
