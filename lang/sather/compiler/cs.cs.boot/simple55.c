...
ptr SIM55_create_(ptr self__, int nm__);
void SIM55_out_of_line_(ptr self__, ptr fn__);
ptr SIM55_dup_(ptr self__);
void SIM55_put_kwdname_(ptr self__, int nm__);
ptr SIM55_sather_code_(ptr self__);
ptr SIM55_initialize_(ptr self__, ptr initarg__);
ptr SIM55_pcopy_(ptr self__, ptr pl__, ptr pi__);
...
char SIM55_base_classname_p_(ptr self__, int i__);
ptr SIM55_disp_type_(ptr self__);
ptr SIM55_name_str_(ptr self__);
ptr SIM55_get_key_(ptr self__, ptr pl__, ptr pi__);
char SIM55_install_simple_inst_(ptr self__, ptr k__);
