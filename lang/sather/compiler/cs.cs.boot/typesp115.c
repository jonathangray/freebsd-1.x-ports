...
ptr TYP115_create_(ptr self__, ptr ts__, int f__, ptr alst__, int ln__);
void TYP115_out_of_line_(ptr self__, ptr fn__);
ptr TYP115_dup_(ptr self__);
void TYP115_put_kwdname_(ptr self__, int nm__);
ptr TYP115_sather_code_(ptr self__);
ptr TYP115_initialize_(ptr self__, ptr initarg__);
void TYP115_resolve_predef_types_(ptr self__, int index__);
void TYP115_semant_(ptr self__, ptr symtab__);
ptr TYP115_typeof_(ptr self__);
int TYP115_get_offset_(ptr self__);
void TYP115_cprint_offset_(ptr self__, ptr outfile__);
ptr TYP115_get_constval_(ptr self__);
void TYP115_cont_cprint_code_(ptr self__, ptr outfile__, int cont__);
void TYP115_cprint_cname_(ptr self__, ptr outfile__);
void TYP115_cprint_extern_(ptr self__, ptr outfile__);
void TYP115_cprint_access_value_(ptr self__, ptr outfile__);
void TYP115_cprint_init_code_(ptr self__, ptr outfile__);
char TYP115_valid_init_expr_(ptr self__);
char TYP115_assignable_p_(ptr self__);
ptr TYP115_gen_temps_(ptr self__);
ptr TYP115_expr_eval_constant_(ptr self__);
void TYP115_get_ext_strs_(ptr self__);
char TYP115_to_be_pre_evaluated_(ptr self__);
char TYP115_access_value_only_(ptr self__);
void TYP115_fob_error_(ptr self__, ptr op_name__, ptr cls_name__);
void TYP115_cprint_pre_code_(ptr self__, ptr outfile__);
void TYP115_cprint_act_code_(ptr self__, ptr outfile__);
void TYP115_cprint_cast_code_(ptr self__, ptr outfile__);
void TYP115_cprint_ith_arg_pre_code_(ptr self__, int i__, ptr outfile__);
void TYP115_cprint_ith_arg_act_code_(ptr self__, int i__, ptr outfile__);
