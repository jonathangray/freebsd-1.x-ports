...
ptr GEN189_create_(ptr self__, ptr nt__);
ptr GEN189_first_(ptr self__);
ptr GEN189_item_(ptr self__);
ptr GEN189_next_(ptr self__);
ptr GEN189_initialize_(ptr self__, ptr initarg__);
