...
void LIS181_clear_(ptr self__);
/*constant*/ int LIS181_def_init_size_ = 5;
ptr LIS181_create_(ptr self__, int init_size__);
ptr LIS181_push_(ptr self__, ptr e__);
int LIS181_size_(ptr self__);
char LIS181_is_empty_(ptr self__);
ptr LIS181_pop_(ptr self__);
ptr LIS181_top_(ptr self__);
void LIS181_init_iterate_(ptr self__);
ptr LIS181_curr_item_(ptr self__);
ptr LIS181_next_item_(ptr self__);
ptr LIS181_prev_item_(ptr self__);
ptr LIS181_push_unique_(ptr self__, ptr e__);
ptr LIS181_append_(ptr self__, ptr list__);
ptr LIS181_union_(ptr self__, ptr list__);
char LIS181_not_in_(ptr self__, ptr e__);
int LIS181_contains_(ptr self__, ptr e__);
ptr LIS181_initialize_(ptr self__, ptr initarg__);
