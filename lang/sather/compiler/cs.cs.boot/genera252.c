...
ptr GEN252_create_(ptr self__);
ptr GEN252_get_(ptr self__, ptr e__);
char GEN252_test_(ptr self__, ptr e__);
void GEN252_double_size_(ptr self__);
void GEN252_insert_(ptr self__, ptr e__);
void GEN252_delete_(ptr self__, ptr e__);
void GEN252_clear_(ptr self__);
ptr GEN252_cursor_(ptr self__);
char GEN252_is_empty_(ptr self__);
ptr GEN252_union_(ptr self__, ptr s__);
ptr GEN252_intersection_(ptr self__, ptr s__);
ptr GEN252_difference_(ptr self__, ptr s__);
ptr GEN252_sym_difference_(ptr self__, ptr s__);
char GEN252_is_a_subset_of_(ptr self__, ptr s__);
ptr GEN252_initialize_(ptr self__, ptr initarg__);
