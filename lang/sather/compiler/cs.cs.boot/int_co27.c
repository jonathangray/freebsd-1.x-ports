...
ptr INT27_create_(ptr self__, ptr v__);
void INT27_out_of_line_(ptr self__, ptr fn__);
ptr INT27_dup_(ptr self__);
void INT27_put_kwdname_(ptr self__, int nm__);
ptr INT27_sather_code_(ptr self__);
ptr INT27_initialize_(ptr self__, ptr initarg__);
ptr INT27_pcopy_(ptr self__, ptr pl__, ptr pi__);
