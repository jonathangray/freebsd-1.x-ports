...
ptr INS150_create_(ptr self__, int index__, int ln__);
void INS150_out_of_line_(ptr self__, ptr fn__);
ptr INS150_dup_(ptr self__);
void INS150_put_kwdname_(ptr self__, int nm__);
ptr INS150_sather_code_(ptr self__);
ptr INS150_initialize_(ptr self__, ptr initarg__);
void INS150_resolve_predef_types_(ptr self__, int new_index__);
void INS150_semant_(ptr self__, ptr symtab__);
ptr INS150_typeof_(ptr self__);
int INS150_get_offset_(ptr self__);
void INS150_cprint_offset_(ptr self__, ptr outfile__);
ptr INS150_get_constval_(ptr self__);
void INS150_cont_cprint_code_(ptr self__, ptr outfile__, int cont__);
void INS150_cprint_cname_(ptr self__, ptr outfile__);
void INS150_cprint_extern_(ptr self__, ptr outfile__);
void INS150_cprint_access_value_(ptr self__, ptr outfile__);
void INS150_cprint_init_code_(ptr self__, ptr outfile__);
int INS150_inst_ind_(ptr self__);
ptr INS150_inst_cls_(ptr self__);
char INS150_is_dispatched_(ptr self__);
ptr INS150_dispatched_(ptr self__);
ptr INS150_undispatched_(ptr self__);
char INS150_arithtype_(ptr self__);
char INS150_int_type_p_(ptr self__);
char INS150_bool_type_p_(ptr self__);
char INS150_char_type_p_(ptr self__);
char INS150_real_type_p_(ptr self__);
char INS150_double_type_p_(ptr self__);
char INS150_str_type_p_(ptr self__);
char INS150_nonptr_p_(ptr self__);
ptr INS150_resolve_arithtype_(ptr self__, ptr tp__);
int INS150_ctype_(ptr self__);
void INS150_cprint_ctype_(ptr self__, ptr outfile__);
void INS150_cprint_void_(ptr self__, ptr outfile__);
char INS150_array_type_p_(ptr self__);
char INS150_array2_type_p_(ptr self__);
char INS150_array3_type_p_(ptr self__);
char INS150_array4_type_p_(ptr self__);
ptr INS150_rettype_(ptr self__);
ptr INS150_paramstype_(ptr self__);
char INS150_conforms_to_(ptr self__, ptr tp__);
char INS150_param_type_conforms_to_(ptr self__, ptr other__);
ptr INS150_full_name_(ptr self__);
void INS150_update_rt_type_(ptr self__, int index__);
int INS150_my_basic_type_(ptr self__);
