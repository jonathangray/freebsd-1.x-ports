...
int OUT80_error_(ptr self__);
ptr OUT80_create_(ptr self__);
ptr OUT80_in_(ptr self__);
ptr OUT80_out_(ptr self__);
ptr OUT80_err_(ptr self__);
char OUT80_check_eof_(ptr self__);
char OUT80_get_c_(ptr self__);
int OUT80_get_ci_(ptr self__);
char OUT80_get_b_(ptr self__);
int OUT80_get_i_(ptr self__);
float OUT80_get_r_(ptr self__);
double OUT80_get_d_(ptr self__);
ptr OUT80_get_s_(ptr self__);
ptr OUT80_get_s_up_to_(ptr self__, char c0__);
void OUT80_unget_c_(ptr self__, char ch__);
ptr OUT80_b_(ptr self__, char bo__);
ptr OUT80_c_(ptr self__, char ch__);
ptr OUT80_i_(ptr self__, int in__);
ptr OUT80_s_(ptr self__, ptr st__);
ptr OUT80_r_(ptr self__, float re__);
ptr OUT80_d_(ptr self__, double do__);
ptr OUT80_nl_(ptr self__);
void OUT80_open_for_read_(ptr self__, ptr nm__);
void OUT80_open_for_write_(ptr self__, ptr nm__);
void OUT80_open_for_append_(ptr self__, ptr nm__);
void OUT80_close_(ptr self__);
ptr OUT80_get_s_of_len_(ptr self__, int n__);
void OUT80_flush_(ptr self__);
void OUT80_open_pipe_for_read_(ptr self__, ptr command__);
void OUT80_open_pipe_for_write_(ptr self__, ptr command__);
void OUT80_close_pipe_(ptr self__);
void OUT80_seek_relative_(ptr self__, int n__);
void OUT80_seek_from_front_(ptr self__, int n__);
void OUT80_seek_from_end_(ptr self__, int n__);
void OUT80_indent_(ptr self__, int steps__);
ptr OUT80_initialize_(ptr self__, ptr initarg__);
