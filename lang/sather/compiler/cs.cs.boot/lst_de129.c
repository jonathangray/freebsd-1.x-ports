...
ptr LST129_create_(ptr self__, int init_size__);
void LST129_out_of_line_(ptr self__, ptr fn__);
ptr LST129_dup_(ptr self__);
void LST129_put_kwdname_(ptr self__, int nm__);
ptr LST129_sather_code_(ptr self__);
ptr LST129_initialize_(ptr self__, ptr initarg__);
void LST129_resolve_predef_types_(ptr self__, int index__);
void LST129_semant_(ptr self__, ptr symtab__);
ptr LST129_typeof_(ptr self__);
int LST129_get_offset_(ptr self__);
void LST129_cprint_offset_(ptr self__, ptr outfile__);
ptr LST129_get_constval_(ptr self__);
void LST129_cont_cprint_code_(ptr self__, ptr outfile__, int cont__);
void LST129_cprint_cname_(ptr self__, ptr outfile__);
void LST129_cprint_extern_(ptr self__, ptr outfile__);
void LST129_cprint_access_value_(ptr self__, ptr outfile__);
void LST129_cprint_init_code_(ptr self__, ptr outfile__);
void LST129_clear_(ptr self__);
/*constant*/ int LST129_def_init_size_ = 5;
ptr LST129_push_(ptr self__, ptr e__);
int LST129_size_(ptr self__);
char LST129_is_empty_(ptr self__);
ptr LST129_pop_(ptr self__);
ptr LST129_top_(ptr self__);
void LST129_init_iterate_(ptr self__);
ptr LST129_curr_item_(ptr self__);
ptr LST129_next_item_(ptr self__);
ptr LST129_prev_item_(ptr self__);
ptr LST129_push_unique_(ptr self__, ptr e__);
ptr LST129_append_(ptr self__, ptr list__);
ptr LST129_union_(ptr self__, ptr list__);
char LST129_not_in_(ptr self__, ptr e__);
int LST129_contains_(ptr self__, ptr e__);
void LST129_cprint_code_(ptr self__, ptr outfile__);
void LST129_validate_dispatches_and_get_ext_strs_(ptr self__);
void LST129_cprint_names_(ptr self__, ptr outfile__);
void LST129_check_separator_code_(ptr self__);
