...
ptr LST123_create_(ptr self__, int init_size__);
void LST123_out_of_line_(ptr self__, ptr fn__);
ptr LST123_dup_(ptr self__);
void LST123_put_kwdname_(ptr self__, int nm__);
ptr LST123_sather_code_(ptr self__);
ptr LST123_initialize_(ptr self__, ptr initarg__);
void LST123_resolve_predef_types_(ptr self__, int index__);
void LST123_semant_(ptr self__, ptr symtab__);
ptr LST123_typeof_(ptr self__);
int LST123_get_offset_(ptr self__);
void LST123_cprint_offset_(ptr self__, ptr outfile__);
ptr LST123_get_constval_(ptr self__);
void LST123_cont_cprint_code_(ptr self__, ptr outfile__, int cont__);
void LST123_cprint_cname_(ptr self__, ptr outfile__);
void LST123_cprint_extern_(ptr self__, ptr outfile__);
void LST123_cprint_access_value_(ptr self__, ptr outfile__);
void LST123_cprint_init_code_(ptr self__, ptr outfile__);
void LST123_clear_(ptr self__);
/*constant*/ int LST123_def_init_size_ = 5;
ptr LST123_push_(ptr self__, ptr e__);
int LST123_size_(ptr self__);
char LST123_is_empty_(ptr self__);
ptr LST123_pop_(ptr self__);
ptr LST123_top_(ptr self__);
void LST123_init_iterate_(ptr self__);
ptr LST123_curr_item_(ptr self__);
ptr LST123_next_item_(ptr self__);
ptr LST123_prev_item_(ptr self__);
ptr LST123_push_unique_(ptr self__, ptr e__);
ptr LST123_append_(ptr self__, ptr list__);
ptr LST123_union_(ptr self__, ptr list__);
char LST123_not_in_(ptr self__, ptr e__);
int LST123_contains_(ptr self__, ptr e__);
void LST123_cprint_code_(ptr self__, ptr outfile__);
int LST123_get_goto_tag_(ptr self__);
void LST123_validate_dispatches_and_get_ext_strs_(ptr self__);
ptr LST123_gen_temps_(ptr self__);
void LST123_gen_goto_tags_(ptr self__, ptr block__);
