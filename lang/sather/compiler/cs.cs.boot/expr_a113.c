...
ptr EXP113_create_(ptr self__, ptr o__, int f__, ptr alst__, int ln__);
void EXP113_out_of_line_(ptr self__, ptr fn__);
ptr EXP113_dup_(ptr self__);
void EXP113_put_kwdname_(ptr self__, int nm__);
ptr EXP113_sather_code_(ptr self__);
ptr EXP113_initialize_(ptr self__, ptr initarg__);
void EXP113_resolve_predef_types_(ptr self__, int index__);
void EXP113_semant_(ptr self__, ptr symtab__);
ptr EXP113_typeof_(ptr self__);
int EXP113_get_offset_(ptr self__);
void EXP113_cprint_offset_(ptr self__, ptr outfile__);
ptr EXP113_get_constval_(ptr self__);
void EXP113_cont_cprint_code_(ptr self__, ptr outfile__, int cont__);
void EXP113_cprint_cname_(ptr self__, ptr outfile__);
void EXP113_cprint_extern_(ptr self__, ptr outfile__);
void EXP113_cprint_access_value_(ptr self__, ptr outfile__);
void EXP113_cprint_init_code_(ptr self__, ptr outfile__);
char EXP113_valid_init_expr_(ptr self__);
char EXP113_assignable_p_(ptr self__);
ptr EXP113_gen_temps_(ptr self__);
ptr EXP113_expr_eval_constant_(ptr self__);
void EXP113_get_ext_strs_(ptr self__);
char EXP113_to_be_pre_evaluated_(ptr self__);
char EXP113_access_value_only_(ptr self__);
void EXP113_fob_error_(ptr self__, ptr op_name__, ptr cls_name__);
void EXP113_cprint_pre_code_(ptr self__, ptr outfile__);
void EXP113_cprint_act_code_(ptr self__, ptr outfile__);
void EXP113_cprint_cast_code_(ptr self__, ptr outfile__);
char EXP113_handle_spec_expr_(ptr self__);
char EXP113_handle_spec_expr_pre_code_(ptr self__, ptr outfile__);
char EXP113_handle_spec_expr_act_code_(ptr self__, ptr outfile__);
void EXP113_cprint_ith_arg_pre_code_(ptr self__, int i__, ptr outfile__);
void EXP113_cprint_ith_arg_act_code_(ptr self__, int i__, ptr outfile__);
char EXP113_requires_dispatched_call_(ptr self__);
