...
ptr GEN183_create_(ptr self__);
ptr GEN183_get_(ptr self__, ptr e__);
char GEN183_test_(ptr self__, ptr e__);
void GEN183_double_size_(ptr self__);
void GEN183_insert_(ptr self__, ptr e__);
void GEN183_delete_(ptr self__, ptr e__);
void GEN183_clear_(ptr self__);
ptr GEN183_cursor_(ptr self__);
char GEN183_is_empty_(ptr self__);
ptr GEN183_union_(ptr self__, ptr s__);
ptr GEN183_intersection_(ptr self__, ptr s__);
ptr GEN183_difference_(ptr self__, ptr s__);
ptr GEN183_sym_difference_(ptr self__, ptr s__);
char GEN183_is_a_subset_of_(ptr self__, ptr s__);
ptr GEN183_initialize_(ptr self__, ptr initarg__);
