...
ptr BOO108_create_(ptr self__, int v__, int ln__);
void BOO108_out_of_line_(ptr self__, ptr fn__);
ptr BOO108_dup_(ptr self__);
void BOO108_put_kwdname_(ptr self__, int nm__);
ptr BOO108_sather_code_(ptr self__);
ptr BOO108_initialize_(ptr self__, ptr initarg__);
void BOO108_resolve_predef_types_(ptr self__, int index__);
void BOO108_semant_(ptr self__, ptr symtab__);
ptr BOO108_typeof_(ptr self__);
int BOO108_get_offset_(ptr self__);
void BOO108_cprint_offset_(ptr self__, ptr outfile__);
ptr BOO108_get_constval_(ptr self__);
void BOO108_cont_cprint_code_(ptr self__, ptr outfile__, int cont__);
void BOO108_cprint_cname_(ptr self__, ptr outfile__);
void BOO108_cprint_extern_(ptr self__, ptr outfile__);
void BOO108_cprint_access_value_(ptr self__, ptr outfile__);
void BOO108_cprint_init_code_(ptr self__, ptr outfile__);
char BOO108_valid_init_expr_(ptr self__);
char BOO108_assignable_p_(ptr self__);
ptr BOO108_gen_temps_(ptr self__);
ptr BOO108_expr_eval_constant_(ptr self__);
void BOO108_get_ext_strs_(ptr self__);
char BOO108_to_be_pre_evaluated_(ptr self__);
char BOO108_access_value_only_(ptr self__);
void BOO108_fob_error_(ptr self__, ptr op_name__, ptr cls_name__);
void BOO108_cprint_pre_code_(ptr self__, ptr outfile__);
void BOO108_cprint_act_code_(ptr self__, ptr outfile__);
void BOO108_cprint_cast_code_(ptr self__, ptr outfile__);
ptr BOO108_val_(ptr self__);
