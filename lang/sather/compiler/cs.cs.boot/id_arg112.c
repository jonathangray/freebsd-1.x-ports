...
ptr ID_112_create_(ptr self__, int id__, ptr alst__, int ln__);
void ID_112_out_of_line_(ptr self__, ptr fn__);
ptr ID_112_dup_(ptr self__);
void ID_112_put_kwdname_(ptr self__, int nm__);
ptr ID_112_sather_code_(ptr self__);
ptr ID_112_initialize_(ptr self__, ptr initarg__);
void ID_112_resolve_predef_types_(ptr self__, int index__);
void ID_112_semant_(ptr self__, ptr symtab__);
ptr ID_112_typeof_(ptr self__);
int ID_112_get_offset_(ptr self__);
void ID_112_cprint_offset_(ptr self__, ptr outfile__);
ptr ID_112_get_constval_(ptr self__);
void ID_112_cont_cprint_code_(ptr self__, ptr outfile__, int cont__);
void ID_112_cprint_cname_(ptr self__, ptr outfile__);
void ID_112_cprint_extern_(ptr self__, ptr outfile__);
void ID_112_cprint_access_value_(ptr self__, ptr outfile__);
void ID_112_cprint_init_code_(ptr self__, ptr outfile__);
char ID_112_valid_init_expr_(ptr self__);
char ID_112_assignable_p_(ptr self__);
ptr ID_112_gen_temps_(ptr self__);
ptr ID_112_expr_eval_constant_(ptr self__);
void ID_112_get_ext_strs_(ptr self__);
char ID_112_to_be_pre_evaluated_(ptr self__);
char ID_112_access_value_only_(ptr self__);
void ID_112_fob_error_(ptr self__, ptr op_name__, ptr cls_name__);
void ID_112_cprint_pre_code_(ptr self__, ptr outfile__);
void ID_112_cprint_act_code_(ptr self__, ptr outfile__);
void ID_112_cprint_cast_code_(ptr self__, ptr outfile__);
void ID_112_cprint_ith_arg_pre_code_(ptr self__, int i__, ptr outfile__);
void ID_112_cprint_ith_arg_act_code_(ptr self__, int i__, ptr outfile__);
