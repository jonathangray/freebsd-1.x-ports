...
void LIS237_clear_(ptr self__);
/*constant*/ int LIS237_def_init_size_ = 5;
ptr LIS237_create_(ptr self__, int init_size__);
ptr LIS237_push_(ptr self__, ptr e__);
int LIS237_size_(ptr self__);
char LIS237_is_empty_(ptr self__);
ptr LIS237_pop_(ptr self__);
ptr LIS237_top_(ptr self__);
void LIS237_init_iterate_(ptr self__);
ptr LIS237_curr_item_(ptr self__);
ptr LIS237_next_item_(ptr self__);
ptr LIS237_prev_item_(ptr self__);
ptr LIS237_push_unique_(ptr self__, ptr e__);
ptr LIS237_append_(ptr self__, ptr list__);
ptr LIS237_union_(ptr self__, ptr list__);
char LIS237_not_in_(ptr self__, ptr e__);
int LIS237_contains_(ptr self__, ptr e__);
ptr LIS237_initialize_(ptr self__, ptr initarg__);
