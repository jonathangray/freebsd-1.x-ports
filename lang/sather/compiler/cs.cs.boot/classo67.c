...
ptr CLA67_initialize_(ptr self__, ptr initarg__);
...
char CLA67_base_classname_p_(ptr self__, int i__);
ptr CLA67_create_(ptr self__, int index__, int lno__, ptr pl__, ptr fl__, char ab__);
int CLA67_num_params_(ptr self__);
char CLA67_non_param_p_(ptr self__);
ptr CLA67_name_str_(ptr self__);
ptr CLA67_filename_(ptr self__);
void CLA67_change_name_(ptr self__, ptr new_nm__);
void CLA67_add_features_(ptr self__, ptr nflst__);
ptr CLA67_features_(ptr self__);
int CLA67_unique_key_(ptr self__);
