...
ptr INT106_create_(ptr self__, ptr v__, int ln__);
void INT106_out_of_line_(ptr self__, ptr fn__);
ptr INT106_dup_(ptr self__);
void INT106_put_kwdname_(ptr self__, int nm__);
ptr INT106_sather_code_(ptr self__);
ptr INT106_initialize_(ptr self__, ptr initarg__);
void INT106_resolve_predef_types_(ptr self__, int index__);
void INT106_semant_(ptr self__, ptr symtab__);
ptr INT106_typeof_(ptr self__);
int INT106_get_offset_(ptr self__);
void INT106_cprint_offset_(ptr self__, ptr outfile__);
ptr INT106_get_constval_(ptr self__);
void INT106_cont_cprint_code_(ptr self__, ptr outfile__, int cont__);
void INT106_cprint_cname_(ptr self__, ptr outfile__);
void INT106_cprint_extern_(ptr self__, ptr outfile__);
void INT106_cprint_access_value_(ptr self__, ptr outfile__);
void INT106_cprint_init_code_(ptr self__, ptr outfile__);
char INT106_valid_init_expr_(ptr self__);
char INT106_assignable_p_(ptr self__);
ptr INT106_gen_temps_(ptr self__);
ptr INT106_expr_eval_constant_(ptr self__);
void INT106_get_ext_strs_(ptr self__);
char INT106_to_be_pre_evaluated_(ptr self__);
char INT106_access_value_only_(ptr self__);
void INT106_fob_error_(ptr self__, ptr op_name__, ptr cls_name__);
void INT106_cprint_pre_code_(ptr self__, ptr outfile__);
void INT106_cprint_act_code_(ptr self__, ptr outfile__);
void INT106_cprint_cast_code_(ptr self__, ptr outfile__);
ptr INT106_val_(ptr self__);
