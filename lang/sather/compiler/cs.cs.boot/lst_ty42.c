...
ptr LST42_create_(ptr self__, int init_size__);
void LST42_out_of_line_(ptr self__, ptr fn__);
ptr LST42_dup_(ptr self__);
void LST42_put_kwdname_(ptr self__, int nm__);
ptr LST42_sather_code_(ptr self__);
ptr LST42_initialize_(ptr self__, ptr initarg__);
ptr LST42_pcopy_(ptr self__, ptr pl__, ptr pi__);
void LST42_clear_(ptr self__);
/*constant*/ int LST42_def_init_size_ = 5;
ptr LST42_push_(ptr self__, ptr e__);
int LST42_size_(ptr self__);
char LST42_is_empty_(ptr self__);
ptr LST42_pop_(ptr self__);
ptr LST42_top_(ptr self__);
void LST42_init_iterate_(ptr self__);
ptr LST42_curr_item_(ptr self__);
ptr LST42_next_item_(ptr self__);
ptr LST42_prev_item_(ptr self__);
ptr LST42_push_unique_(ptr self__, ptr e__);
ptr LST42_append_(ptr self__, ptr list__);
ptr LST42_union_(ptr self__, ptr list__);
char LST42_not_in_(ptr self__, ptr e__);
int LST42_contains_(ptr self__, ptr e__);
