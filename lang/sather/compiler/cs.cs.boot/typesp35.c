...
ptr TYP35_create_(ptr self__, ptr ts__, int f__, ptr alst__);
void TYP35_out_of_line_(ptr self__, ptr fn__);
ptr TYP35_dup_(ptr self__);
void TYP35_put_kwdname_(ptr self__, int nm__);
ptr TYP35_sather_code_(ptr self__);
ptr TYP35_initialize_(ptr self__, ptr initarg__);
ptr TYP35_pcopy_(ptr self__, ptr pl__, ptr pi__);
