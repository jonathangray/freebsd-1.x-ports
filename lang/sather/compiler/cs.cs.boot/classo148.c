...
ptr CLA148_initialize_(ptr self__, ptr initarg__);
...
char CLA148_base_classname_p_(ptr self__, int i__);
...
char CLA148_compile_key_p_(ptr self__, int i__);
...
ptr CLA148_create_(ptr self__, ptr d__, ptr k__, ptr pi__);
void CLA148_copy_features_(ptr self__);
void CLA148_update_ind_(ptr self__, int i__);
void CLA148_mark_is_used_(ptr self__);
ptr CLA148_make_prefix_(ptr self__);
ptr CLA148_make_cfilename_(ptr self__);
char CLA148_parametrized_p_(ptr self__);
ptr CLA148_name_str_(ptr self__);
ptr CLA148_full_name_(ptr self__);
void CLA148_update_ctype_(ptr self__);
ptr CLA148_get_feature_(ptr self__, int index__);
ptr CLA148_store_feature_unique_(ptr self__, ptr new_flst__, ptr fo__);
void CLA148_eliminate_dup_(ptr self__);
char CLA148_expand_cinh_(ptr self__);
ptr CLA148_alias_feature_(ptr self__, ptr new_flst__, ptr f__);
/*constant*/ ptr CLA148_invar_feature_name_ = (ptr)(&gs496_);
ptr CLA148_get_invariant_(ptr self__);
void CLA148_add_invariant_(ptr self__);
void CLA148_add_initializer_(ptr self__, ptr init_attr_lst__);
void CLA148_resolve_predef_types_and_compute_num_attrs_(ptr self__);
int CLA148_compute_pdepth_(ptr self__);
void CLA148_add_unique_anc_(ptr self__, int anc_index__);
void CLA148_compute_anc_(ptr self__);
void CLA148_compute_des_(ptr self__);
void CLA148_compute_pdes_(ptr self__);
void CLA148_add_new_des_(ptr self__, ptr newDes__);
void CLA148_add_new_anc_(ptr self__, ptr newAnc__);
void CLA148_adjust_parent_alldes_(ptr self__);
void CLA148_compute_time_stamp_(ptr self__);
void CLA148_compute_attr_offsets_(ptr self__);
void CLA148_pre_semant_(ptr self__);
void CLA148_semant_(ptr self__);
void CLA148_mark_callees_and_callers_(ptr self__);
void CLA148_misc_info_(ptr self__);
void CLA148_cprint_macros_(ptr self__, ptr outfile__);
void CLA148_cprint_header_and_macros_(ptr self__, ptr outfile__);
void CLA148_cprint_externs_(ptr self__, ptr outfile__);
void CLA148_cprint_ext_strs_(ptr self__, ptr outfile__);
void CLA148_cprint_declns_(ptr self__, ptr outfile__);
void CLA148_cprint_attr_tbl_(ptr self__, ptr outfile__);
void CLA148_cprint_feat_tbl_(ptr self__, ptr outfile__);
void CLA148_cprint_des_tbl_(ptr self__, ptr outfile__);
void CLA148_cprint_routines_(ptr self__, ptr outfile__);
void CLA148_cprint_ctype_(ptr self__, ptr outfile__);
int CLA148_cprint_extern_feats_(ptr self__, ptr outfile__);
void CLA148_cprint_insert_feats_(ptr self__, ptr outfile__);
void CLA148_cprint_post_rtcode_(ptr self__, ptr outfile__);
void CLA148_cprint_pre_rtcode_(ptr self__, ptr outfile__);
void CLA148_cprint_init_shareds_and_consts_(ptr self__, ptr outfile__);
