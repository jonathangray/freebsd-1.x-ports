...
ptr INT214_create_(ptr self__, ptr t__);
int INT214_first_(ptr self__);
int INT214_item_(ptr self__);
int INT214_next_(ptr self__);
ptr INT214_initialize_(ptr self__, ptr initarg__);
