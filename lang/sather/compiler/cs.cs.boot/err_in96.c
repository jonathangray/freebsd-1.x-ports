...
void ERR96_warning_msg_(ptr self__, ptr s__);
void ERR96_error_msg_(ptr self__, ptr s__);
void ERR96_compiler_error_msg_(ptr self__, ptr classname__, ptr msg__);
void ERR96_error_exit_(ptr self__, ptr s__);
void ERR96_format_warning_msg_(ptr self__, int ln__, ptr s__);
void ERR96_format_error_msg_(ptr self__, int ln__, ptr s__);
void ERR96_format_warning_msg_file_(ptr self__, ptr file__, int ln__, ptr cls__, ptr s__);
void ERR96_format_error_msg_file_(ptr self__, ptr file__, int ln__, ptr cls__, ptr s__);
void ERR96_format_error_exit_(ptr self__, int ln__, ptr s__);
ptr ERR96_filename_(ptr self__);
/*shared*/ ptr ERR96_ool_file_names_;
/*shared*/ ptr ERR96_ool_lines_;
int ERR96_out_of_line_err_info_(ptr self__, ptr f__, int ln__);
int ERR96_def_lineno_(ptr self__, int ln__);
ptr ERR96_def_filename_(ptr self__, int ln__);
ptr ERR96_def_classname_(ptr self__);
int ERR96_feat_lineno_(ptr self__);
void ERR96_type_mismatch_err_(ptr self__, ptr where__, ptr comnt__, ptr t1__, ptr t2__, int ln__);
ptr ERR96_initialize_(ptr self__, ptr initarg__);
