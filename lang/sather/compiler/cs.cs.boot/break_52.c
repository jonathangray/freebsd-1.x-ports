...
ptr BRE52_create_(ptr self__, ptr expr__);
void BRE52_out_of_line_(ptr self__, ptr fn__);
ptr BRE52_dup_(ptr self__);
void BRE52_put_kwdname_(ptr self__, int nm__);
ptr BRE52_sather_code_(ptr self__);
ptr BRE52_initialize_(ptr self__, ptr initarg__);
ptr BRE52_pcopy_(ptr self__, ptr pl__, ptr pi__);
ptr BRE52_inhcreate_(ptr self__);
