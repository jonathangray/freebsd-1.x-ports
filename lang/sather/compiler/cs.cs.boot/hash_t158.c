...
ptr HAS158_create_(ptr self__, int size__);
int HAS158_hash_(ptr self__, int nm__);
ptr HAS158_get_obj_(ptr self__, int nm__);
char HAS158_add_obj_(ptr self__, int nm__, ptr ob__);
void HAS158_add_unique_obj_(ptr self__, int nm__, ptr ob__);
void HAS158_double_tables_(ptr self__);
char HAS158_remove_obj_(ptr self__, int nm__);
ptr HAS158_initialize_(ptr self__, ptr initarg__);
