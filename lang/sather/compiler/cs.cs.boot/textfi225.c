...
int TEX225_error_(ptr self__);
ptr TEX225_create_(ptr self__, ptr nm__);
ptr TEX225_in_(ptr self__);
ptr TEX225_out_(ptr self__);
ptr TEX225_err_(ptr self__);
char TEX225_check_eof_(ptr self__);
char TEX225_get_c_(ptr self__);
int TEX225_get_ci_(ptr self__);
char TEX225_get_b_(ptr self__);
int TEX225_get_i_(ptr self__);
float TEX225_get_r_(ptr self__);
double TEX225_get_d_(ptr self__);
ptr TEX225_get_s_(ptr self__);
ptr TEX225_get_s_up_to_(ptr self__, char c0__);
void TEX225_unget_c_(ptr self__, char ch__);
ptr TEX225_b_(ptr self__, char bo__);
ptr TEX225_c_(ptr self__, char ch__);
ptr TEX225_i_(ptr self__, int in__);
ptr TEX225_s_(ptr self__, ptr st__);
ptr TEX225_r_(ptr self__, float re__);
ptr TEX225_d_(ptr self__, double do__);
ptr TEX225_nl_(ptr self__);
void TEX225_open_for_read_(ptr self__, ptr nm__);
void TEX225_open_for_write_(ptr self__, ptr nm__);
void TEX225_open_for_append_(ptr self__, ptr nm__);
void TEX225_close_(ptr self__);
ptr TEX225_get_s_of_len_(ptr self__, int n__);
void TEX225_flush_(ptr self__);
void TEX225_open_pipe_for_read_(ptr self__, ptr command__);
void TEX225_open_pipe_for_write_(ptr self__, ptr command__);
void TEX225_close_pipe_(ptr self__);
void TEX225_seek_relative_(ptr self__, int n__);
void TEX225_seek_from_front_(ptr self__, int n__);
void TEX225_seek_from_end_(ptr self__, int n__);
void TEX225_error_msg_(ptr self__, ptr s__);
void TEX225_error_exit_(ptr self__, ptr s__);
char TEX225_whitespace_(ptr self__, char ch__);
char TEX225_read_next_(ptr self__);
int TEX225_get_token_(ptr self__);
ptr TEX225_initialize_(ptr self__, ptr initarg__);
