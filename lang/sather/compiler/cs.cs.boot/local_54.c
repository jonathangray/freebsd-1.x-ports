...
ptr LOC54_create_(ptr self__, ptr decl__, ptr exp__);
void LOC54_out_of_line_(ptr self__, ptr fn__);
ptr LOC54_dup_(ptr self__);
void LOC54_put_kwdname_(ptr self__, int nm__);
ptr LOC54_sather_code_(ptr self__);
ptr LOC54_initialize_(ptr self__, ptr initarg__);
ptr LOC54_pcopy_(ptr self__, ptr pl__, ptr pi__);
void LOC54_mark_private_(ptr self__);
ptr LOC54_create_lst_(ptr self__, ptr decl__);
int LOC54_ith_name_(ptr self__, int i__);
