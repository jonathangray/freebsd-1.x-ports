...
ptr DIS56_create_(ptr self__, ptr t__);
void DIS56_out_of_line_(ptr self__, ptr fn__);
ptr DIS56_dup_(ptr self__);
void DIS56_put_kwdname_(ptr self__, int nm__);
ptr DIS56_sather_code_(ptr self__);
ptr DIS56_initialize_(ptr self__, ptr initarg__);
ptr DIS56_pcopy_(ptr self__, ptr pl__, ptr pi__);
...
char DIS56_base_classname_p_(ptr self__, int i__);
ptr DIS56_disp_type_(ptr self__);
ptr DIS56_name_str_(ptr self__);
ptr DIS56_get_key_(ptr self__, ptr pl__, ptr pi__);
