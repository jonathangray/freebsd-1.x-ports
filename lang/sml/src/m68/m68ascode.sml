...
structure M68Assem = struct val outfile = ref(IO.std_out) end
...
fun jcc (arg as (Address lab)) = (emit "jcc "; emit1arg arg)
fun jls (arg as (Address lab)) = (emit "jls "; emit1arg arg)
...
fun fcmpd arg = (emit "fcmpd "; emit2arg arg)
fun faddd arg = (emit "faddd "; emit2arg arg)
fun fsubd arg = (emit "fsubd "; emit2arg arg)
fun fmuld arg = (emit "fmuld "; emit2arg arg)
fun fdivd arg = (emit "fdivd "; emit2arg arg)
****)
fun fmoved arg = (emit "fmoved "; emit2arg arg)
fun fmovel arg = (emit "fmovel "; emit2arg arg)

fun fcmpx arg = (emit "fcmpd "; emit2arg arg)
fun faddx arg = (emit "faddd "; emit2arg arg)
fun fsubx arg = (emit "fsubd "; emit2arg arg)
fun fmulx arg = (emit "fmuld "; emit2arg arg)
fun fdivx arg = (emit "fdivd "; emit2arg arg)
fun fnegx arg = (emit "fnegd "; emit2arg arg)
fun fabsx arg = (emit "fabsd "; emit2arg arg)
fun fmovex arg = (emit "fmoved "; emit2arg arg)
