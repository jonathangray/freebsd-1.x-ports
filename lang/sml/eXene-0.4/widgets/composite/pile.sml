...
structure Pile : PILE = 
  struct
    ...
    fun bounds f Empty = W.fixBounds(1,1)
    ...
    fun makeReal (mkr, Empty) = Empty
      | makeReal (mkr, P{top,widget,wlist}) = let
          ...
          in
            P{top = top,wlist = wl,widget = nth(wl,top)}
          end
    ...
    fun mkPile root widgets = let
          ...
          fun realize {env = inenv as InEnv{co=myco,...}, win, sz} widgets = let
                ...
                fun mkReal sz = let
                      ...
                      in
                        fn widget => let
                        val cwin = W.wrapCreate (win, rect) 
          ...
          in
            ...
            Pile {
              widget=W.mkWidget {
                root=root,
                boundsOf = (fn () => (send (reqChan, Bounds); accept sizeChan)),
