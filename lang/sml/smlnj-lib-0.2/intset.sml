...
structure IntSet : INTSET =
	...
	in
	    ...
	    val union = hedge_union
            ...
            fun addList (s,l) = List.revfold (fn (i,s) => add(s,i)) l s
	    ...
	    fun app f set = let
		  ...
		  in 
            ...
            local
              ...
              fun treeIn (t,t') = let
		    fun isIn E = true
		      | isIn (T(v,_,E,E)) = member(t',v)
		      | isIn (T(v,_,l,E)) = 
                          member(t',v) andalso isIn l
		      | isIn (T(v,_,E,r)) = 
                          member(t',v) andalso isIn r
		      | isIn (T(v,_,l,r)) = 
                          member(t',v) andalso isIn l andalso isIn r
                    in
                      isIn t
                    end
            in
