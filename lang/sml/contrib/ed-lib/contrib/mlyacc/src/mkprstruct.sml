   ...
   struct
    (*open Array List*)
	 ...
	 decimal escape sequence for it *)
      ...
      val chr =
	let val lookup = Array.create 256 "\000"
	    val intToString = fn i =>
		if i>=100 then "\\" ^ (Int.string i)
		else if i>=10 then "\\0" ^ (Int.string i)
		else  "\\00" ^ (Int.string i)
	...
	in print "val ";
	   ...
	   print "val numstates = ";
	   print (Int.string states);
	   print "\nval numrules = ";
	   print (Int.string rules);
	   print "\n\
...
print (Int.string ((fn (STATE i) => i) (initialState table)));
print "}\nend\n";
      entries
      end
end;
