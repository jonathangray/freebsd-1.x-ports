...
DESCRIPTION
   ...
   SML/NJ provides a substring operation similar to extract.
...
Revision 1.2  1991/10/22  18:31:55  db
Fixed bug in string function.

Revision 1.1  91/09/13  14:26:01  14:26:01  db (Dave Berry)
Initial revision
...
(* MANIPULATING THE NTH ELEMENT *)
  ...
  infix 9 sub
  fun s sub n = chr (OldString.ordof (s, n))
		handle OldString.Ord => raise Subscript ("sub", n)
