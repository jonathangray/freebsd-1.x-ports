(*
	...
	@(#)idl-0.93.sml	2.1 93/03/08 00:57:56
*)

val Title   = "IDL: ";
val Version = "@(#)idl-0.93.sml	2.1 93/03/08 00:57:56";
...
(*
	...
	March '93               Compatible with sml-0.93
...
use  "lib/list.sig.sml";
use  "lib/list.sml"; structure list=list(); open list;
use  "lib/streamio.sig.sml";
use  "lib/streamio.sml"; structure streamio=streamio(); open streamio;
