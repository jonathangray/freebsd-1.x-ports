     ...
     int *new_width, *new_height;
{
  ...
  if (new_width != nil) *new_width = brush_width;
  if (new_height != nil) *new_height = brush_height;
  return(! cancelled);
}

static draw_dialog(win) 
     Window win;
{
...
static drag_brush(report, pwidth, pheight)
     XEvent report;
     int *pwidth, *pheight;
{
