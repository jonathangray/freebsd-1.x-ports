...
/* LOCAL doenter(sym,argc,argv) *//* made global for method tracing */
doenter(sym,argc,argv)
...
/* LOCAL doexit(sym,val) *//* made global for method tracing */
doexit(sym,val) 
  LVAL sym,val;
{
    extern int xltrcindent;
