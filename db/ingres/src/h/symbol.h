...
*/
#ifndef INGRES_SYMBOL_H_
#define INGRES_SYMBOL_H_
...
#define	INT_CONST	'i'		/* INTEGER CONSTANT */
#define	FLOAT_CONST	'f'		/* FLOATING POINT CONSTANT */
#define	CHAR_CONST	'c'		/* CHARACTER CONSTANT */
...
#define	PAT_SPEC	6		/* matches 0 or more char and indices them */

/*	The following are interval delimiter types used by ovqp  */
#define	OPEN		0
#define	CLOSED		1

#endif /* !INGRES_SYMBOL_H_ */
