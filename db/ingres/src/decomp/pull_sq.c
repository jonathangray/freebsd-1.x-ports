...
void
pull_sq(qtree_t *tree1, qtree_t **sqlist, int *locrang, int *sqrange, char *buf)
{
	register qtree_t 	*q, *tree, *r;
	qtree_t 		*s;
	int 		anysq, j, badvar;
...
*/
void
maktl(qtree_t *node, char *buf, qtree_t *sq1, int varno)
{
	register qtree_t 	*resdom, *tree, *sq;
	int		domno, map;
...
*/
void
dfind(register qtree_t *tree, char *buf, qtree_t **sqlist)
{
	register char	varno;
	register qtree_t	*sq;
