...
openheader(struct header *hd, char *filename)
{
	register int	fd, i;
...
pr_values(char *str, int secs, char *std, char *dyl, int flag)
{
...
void
bmove(char *src, char *dst, int len)
{
	register int	i;
	register char	*s, *d;
...
int
bequal(char *s1, char *s2, int len)
{
	register int	i;
	register char	*s, *d;
