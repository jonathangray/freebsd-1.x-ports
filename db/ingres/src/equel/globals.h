...
**
**	Version:
**		@(#)globals.h	8.1	12/31/84
*/
#ifndef INGRES_EQUEL_GLOBALS_H_
#define INGRES_EQUEL_GLOBALS_H_
...
int		Struct_flag;		/* while processing a structure
					 ...
					 */
cvar_t	*Cvarp, *Fieldp;		/* to process C variables */
...
struct special		Tokens;		/* holds yacc generated lex codes
					 * [tokens.y]
					 */
cvar_t		*C_globals;	/* Global C-variable tree */
cvar_t		*C_locals;	/* Local C-variable tree */
cvar_t		*F_locals;	/* Local structure fields */
cvar_t		*F_globals;	/* Global structure fields */
