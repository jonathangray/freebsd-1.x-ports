...
*/
#ifndef INGRES_EQUEL_CONSTANTS_H_
#define INGRES_EQUEL_CONSTANTS_H_

/* need to include this for MAX_FIELD_SIZE and MAXFILENAMESIZ */
#include "gconst.h"

#define	CONTINUE	1	/* "loop" flag for yylex */

#define	MAXSTRING	MAX_FIELD_SIZE /* maximum length for equel strings */
#define	FILLCNT		110	/* length to fill lines when in Fillmode */

#define	MAXEQNAME	(MAXSTRING - 1)
				/* maximum length for equel 
...
#endif /* INGRES_EQUEL_CONSTANTS_H_ */
