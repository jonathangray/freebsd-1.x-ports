...
c     some of the eigenvalues for the eigenproblem  a*x = (lambda)*b*x.
c
c     this driver is catalogued as  eispdrv4(rsgeispk).
c
...
c
      nm = 20
      open(unit=1,file='rsdatai')
      open(unit=2,file='rsgdatai')
      open(unit=5,file='rsdatas')
      rewind 1
      rewind 2
      rewind 5
...
c
  ...
  715    format(//28h *****error from rsg***** = ,i4)
...
c
  ...
  765    format(//30h *****error from reduc***** = ,i4)
...
c
  ...
  806    format(//28h *****error from rsg***** = ,i4)
         if( error .eq. 7*n + 1 ) go to 230
         maxeig = 0.0d0
         maxdif = 0.0d0
         m = n
...
c
  ...
  856    format(//30h *****error from reduc***** = ,i4)
...
c
  ...
  893    format(//30h *****error from reduc***** = ,i4)
         if( error .ne. 0 ) go to 230
...
c
  ...
  915    format(//30h *****error from reduc***** = ,i4)
         if( error .ne. 0 ) go to 230
         call  tred1(nm,n,a,d,e,e2)
...
c
  ...
  965    format(//30h *****error from reduc***** = ,i4)
         call  tred1(nm,n,a,d,e,e2)
...
c
 ...
 1015    format(//30h *****error from reduc***** = ,i4)
         if( error .ne. 0 ) go to 230
         call  tred1(nm,n,a,d,e,e2)
         call  bisect(n,eps1,d,e,e2,lb,ub,mm,m,w,ind,error,rv4,rv5)
...
c
 ...
 1115    format(//30h *****error from reduc***** = ,i4)
         if( error .ne. 0 ) go to 230
         call  tred1(nm,n,a,d,e,e2)
  ...
  114    format(//31h *****error from tinvit***** = ,i4)
         ...
         go to  150
c
c     rsg1w  using  tridib
c
  115    write(iwrite,101)
         eps1 = 0.0d0
         call  reduc(nm,n,a,b,dl,error)
         write(iwrite,1165) error
 1165    format(//30h *****error from reduc***** = ,i4)
         if( error .ne. 0 ) go to 230
         call  tred1(nm,n,a,d,e,e2)
         call  tridib(n,eps1,d,e,e2,lb,ub,m11,no,w,ind,error,rv4,rv5)
...
c
  ...
  190    call  rmatin(nm,n,a,b,ahold,bhold,1)
         call  rsgwzr(nm,n,m,a,b,w,z,norm,resdul)
  ...
  212       write(iwrite,213) (w(k),k=kk,kk1),(norm(k),k=kk,kk1),  
     x           ((z(i,k),k=kk,kk1),i=1,n)
  213    format(///1x,3(5x,24heigenvalue of a-lambda*b,3x)/
     x   1x,3(4x,1pd24.16,4x)//
     x   1x,3(5x,23h1-norm of corresponding,4x)/
     x   1x,3(9x,15hresidual vector,8x)/
     x   1x,3(7x,19h!!a*z-b*z*diag(w)!!,6x)/
     x   1x,3(5x,22h----------------------,5x)/
     x   1x,3(11x,11h!!a!!*!!z!!,11x)//
     x   1x,3(8x,d16.8,8x)//
