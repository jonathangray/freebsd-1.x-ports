 ...
 * 
 * $NCDId: @(#)aiff.c,v 1.3 1993/11/03 19:24:02 greg Exp $
 */
...
#define cmpID(_x, _y)	strncmp(_x, _y, sizeof(AIFF_ID))
 ...
 *  and accuracy.
 *
 * This code may be used and freely distributed as AuInt32 as it includes
