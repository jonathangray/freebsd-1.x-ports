 ...
 *
 * $NCDId: @(#)Slider.c,v 1.2 1994/02/10 00:49:01 greg Exp $
 */
                ...
                force;
{
	...
	XtCallCallbacks(w, XtNcallback, w->slider.value);
    }
}

static void
scroll(w, sw, position)
Widget          w;
SliderWidget    sw;
int             position;
{
...
Cardinal       *num_args;
{
    ...
    XtVaSetValues(w, XtNborderWidth, 0, XtNdefaultDistance, 0, NULL);
    ...
    w->slider.scrollbarW =
	XtCreateManagedWidget("scrollbar", scrollbarWidgetClass, w, NULL, 0);
