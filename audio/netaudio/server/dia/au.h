 ...
 * 
 * $NCDId: @(#)au.h,v 1.11 1994/01/21 22:52:44 greg Exp $
 */
...
typedef struct _ComponentRec
{
    ...
    AuInt32         readPhase,			/* for sample rate conversion */
                    writePhase;			/* for sample rate conversion */
    AuUint8        *minibuf,			/* chunk storage */
                   *data,			/* start of data */
                   *dataEnd,			/* end of data */
                   *lastRead,			/* for sample rate conversion */
                   *lastWrite;			/* for sample rate conversion */
...
{									      \
    int extra = PAD4((numTracks) * auNativeBytesPerSample) +		      \
	(numChildren) * sizeof(AuID) * 2;				      \
									      \
