#ifndef lint
static char * rcsid = "$Header: /a/cvs/386BSD/ports/news/nntp/xmit/get_tcp_conn.c,v 1.1 1993/07/19 20:04:34 nate Exp $";
#endif
#define USE_KEEPALIVES /* XXX should be in ../common/conf.h */
