...
webfilename,changefilename,pascalfilename,poolfilename:array[1..
FILENAMESIZE]of char;{:189}{30:}{procedure debughelp;forward;}{:30}{31:}
procedure error;var j:0..outbufsize;k,l:0..bufsize;
...
slashpos:=-1;i:=1;
while(fname[i]<>' ')and(i<=FILENAMESIZE-5)do begin webfilename[i]:=fname
[i];if fname[i]='.'then dotpos:=i;if fname[i]='/'then slashpos:=i;
i:=i+1;end;webfilename[i]:=' ';
...
scanargs;rewrite(Pascalfile,pascalfilename);{:26}{42:}
