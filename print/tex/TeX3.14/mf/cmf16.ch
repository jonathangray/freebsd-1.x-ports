...
@y
@d banner=='This is METAFONT, C Version 2.7' {printed when \MF\ starts}
@z
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% [??] Put the memory structure into an include file, since it's too
...
loop@+begin
  ...
  pack_cur_name; {Try adding |".mf"|, even if we already have an extension.}
  if name_length < file_name_size + 4 {Don't overflow the array.}
  then begin
