...
the file |tugboat.com|, and users of either style should read the
...
|ltugboat.sty| is the primary macro file, |tugboat.com| a collection of
items common to both \LaTeX\ and \plain\ input.  Articles will have
the form:
\verbatim[\makeescape\|]
...
|\makesignature| on page 379 to understand more.  Linebreaks
...
and |\BibTeX| are contained in |tugboat.com|.  Please use these whenever
...
|tugboat.com|.  Various |\*lap|\,s (|\ulap|, |\dlap|, |\xlap|,
...
this article.  Readers may look at the end of |tugboat.com| after the
...
|tugboat.com| defines |\xrefto| so that ``???'' is typeset whenever it
