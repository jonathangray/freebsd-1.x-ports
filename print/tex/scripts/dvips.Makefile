...
#      -DVOID=char
#
# DEFS= -DTPIC -DDEBUG -DDEFRES=300 -DCREATIONDATE -DHAVE_GETCWD \
...
install : afm2tfm dvips MakeTeXPK mftopk mftopk.1 askmf.awk askmf.mf \
