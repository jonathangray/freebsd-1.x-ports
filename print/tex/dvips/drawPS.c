 ...
 *
 * $Log: drawPS.c,v $
 * Revision 1.1  1993/11/07 19:08:35  nate
 * dvips that uses MetaFont and MakeTeXPK to build fonts 'on the fly'.  By
 * defualt we are creating 300 DPI fonts for a Canon laser printer, since
 * this is the common setup of most laser printers.  The current modes.mf
 * file in the TeX distribution needs to be updated in order to get higher
 * resolution fonts for the Canon engine.
 *
 * dvips installs all the necessary tools that xdvi requires to do it's job
 * that are not installed in the TeX installation.
 *
...
#ifndef lint
char RCSid[] =
  "@(#)$Header: /a/cvs/386BSD/ports/print/tex/dvips/drawPS.c,v 1.1 1993/11/07 19:08:35 nate Exp $ (UCLA)";
#endif
