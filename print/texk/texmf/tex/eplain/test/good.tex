...
%%   version = "2.2",
%%   date = "Wed Nov 11 06:40:30 EST 1992",
%%   filename = "eplain.tex",
%%   email = "karl@cs.umb.edu",
%%   address = "135 Center Hill Rd. // Plymouth, MA 02360"
%%   checksum = "1870    4680   64461",
%%   codetable = "ISO/ASCII",
%%   supported = "yes",
...
%%% ====================================================================
\ifx\sc\undefined
    \font\sc=cmcsc10   % must be plain TeX or AmSTeX
\fi
...
\ifx\MF\undefined
    ...
    \def\MF{{\ifdim\fontdimen1\font>0pt \let\manfnt = \manfntsl \fi
      {\manfnt META}\-{\manfnt FONT}}}%
\fi
\ifx\METAFONT\undefined
    \let\METAFONT=\MF
\fi
...
\def\leftdisplays{%
  ...
  \everydisplay = \expandafter{\the\previouseverydisplay \displaysetup}%
...
\def\writeitemxref#1{%
  \toks0 = {#1}%
  \readauxfile
  \edef\@wr{\noexpand\writeaux{\string\@definexref{\the\toks0}{\marker}}}%
  \@wr
}%
\def\printitem{%
  \par
...
\def\verbatim{%
  ...
  \makeactive\`
  \def\|{|}%
  \catcode`\|=0 % | will be the escape character
  \tt
}%
...
\def\@definexref#1#2{\expandafter\gdef\csname\xrlabel{#1}\endcsname{#2}}%
...
\def\@eqdefn#1#2{%
  \readauxfile
  \edef\@wr{\noexpand\immediatewriteaux{\string\@definexref{#1}{#2}}}%
  \@wr
  \expandafter\xdef\csname\xrlabel{#1}\endcsname{#2}%
  \ignorespaces
}%
...
{\edef\plainversion{\fmtversion}%
 \xdef\fmtversion{2.2: 11 November 1992 (and plain \plainversion)}%
}%
