...
/* Append the result of `getenv (var)' to EXPANSION, where `var' begins
...
/* Maybe we should generalize to allow some or all of the various shell
   ${...} constructs.  See comments at `kpse_make_specs' in
   `tex-make.c', for example.  */
...
/*
Local variables:
standalone-compile-command: "gcc -posix -g -I. -I.. -DTEST variable.c kpathsea.a"
End:
*/
