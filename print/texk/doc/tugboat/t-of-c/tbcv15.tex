...
\input tb1190.cnt               % 1990: 11#1, #2, #3, #4
\newpage
\input tb1291.cnt               % 1991: 12#1, #2, #3, #4
\newpage
\input tb1392.cnt               % 1992: 13#1, #2, #3, #4
\newpage
\input tb1493.cnt               % 1993: 14#1, #2, #3, #4
\newpage
% \input tb1594.cnt             % 1994: 15#1, #2, #3, #4
