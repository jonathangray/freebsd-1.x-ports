...
%%     abstract="This file contains the TeX source for 
%%      the AMSFonts 2.1 User's Guide. It inputs the files
%%      USERDOC.DEF, USERDOC.CYR, USERDOC.FNT, and USERDOC.INS
...
\maintitle User's Guide to AMSFonts Version 2.1\\
  \fontsreleasedate<
...
\Warn  The fonts in this collection are suitable for use with
  \AmSTeX{} Version~2.0$+$ and \AmS-\LaTeX{} Version~1.0$+$,
   but are not compatible with earlier versions
  of \AmSTeX{}.  If you are using an older version of \AmSTeX{} and are
  intending to use fonts from this Version~2.1 collection, you should
  obtain a new version of \AmSTeX{}.
...
\item{\bull} How to use AMSFonts 2.1 with \AmSTeX{} 2.0$+$ \dotsfill\ \ppAMSTeX{}

\item{\bull} How to use AMSFonts 2.1 without \AmSTeX{}
...
\item{\bull} Appendix A - Installation Procedures --
    PC\dotsfill\ \ppinstallpc{}

\item{\bull} Appendix B - Installation Procedures -- Macintosh\dotsfill\ 
                        \ppinstallmac{}
...
\itemitem{--} \filename{USERDOC.DEF}, the macros used to format this
  User's Guide
\itemitem{--} \filename{USERDOC.INS}, the source file for the appendixes
...
\title How to use AMSFonts 2.1 with \AmSTeX{} 2.0$+$
...
\title How to use AMSFonts 2.1 without \AmSTeX{}
...
fonts, see the ``Euler'' subsections under {\bf How to use AMSFonts 2.1 with
\AmSTeX{} 2.0+} and {\bf How to use AMSFonts 2.1 without \AmSTeX}.
...
\smallskip
\parskip=0pt
\TextAddr Technical Support Department
  \AMS{}
  \POBox 6248
  Providence, RI 02940
...
\1 [AMS91] {\sl User's Guide to \AmSTeX{} Version~2.1, January 1991},
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\def \appendixtitlex{Font charts to be used in Figure 1}
