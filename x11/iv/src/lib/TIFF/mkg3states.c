#ifndef lint
static char rcsid[] = "$Header: /a/cvs/386BSD/ports/x11/iv/src/lib/TIFF/mkg3states.c,v 1.1 1994/04/27 00:03:58 adam Exp $";
#endif
 ...
 *
 *	Reference: $Id: mkg3states.c,v 1.1 1994/04/27 00:03:58 adam Exp $
 *
