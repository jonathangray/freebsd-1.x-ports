#ifndef lint
static char rcsid[] = "$Header: /a/cvs/386BSD/ports/x11/tiff/mkg3states.c,v 1.1 1993/08/18 21:10:20 smace Exp $";
#endif
 ...
 *
 *	Reference: $Id: mkg3states.c,v 1.1 1993/08/18 21:10:20 smace Exp $
 *
