/*
 * $Id: tool.c,v 1.1 1993/08/17 09:42:31 alm Exp $
 */
/*
...
static Xv_Cursor panel_cursor, canvas_cursor;
Frame date_frame = 0;
...
create_panel()
{
	...
	month_menu = xv_create(NULL, MENU,
			XV_FONT, menufont,
...
#ifndef NO_PRINTER
	print_menu = xv_create(NULL, MENU,
			XV_FONT, menufont,
	...
	previous_menu = xv_create(NULL, MENU,
			XV_FONT, menufont,
	...
	current_menu = xv_create(NULL, MENU,
			XV_FONT, menufont,
	 ...
	 * (day display).
	 */
	day_sel_menu = xv_create(NULL, MENU,
			XV_FONT, menufont,
...
create_file_frame()
{
	...
	xv_set(filepanel, XV_FONT, font, 0);
	...
	def = xv_create(filepanel, PANEL_BUTTON,
	...
	xv_set(filepanel, PANEL_DEFAULT_ITEM, def, 0);
