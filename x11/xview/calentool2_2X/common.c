/*
 * $Id: common.c,v 1.1 1993/08/17 09:42:28 alm Exp $
 */
/*
 * common.c
 * 
...
#endif
extern char *strcpy(), *strncpy(), *index();
...
int dpyflag;
{
	...
	if ((slotno + nappt->arrows) >= n_tslots)
		n_arrows = n_tslots - slotno - 1;	/* truncate */
	else
 ...
 */
#ifndef CALENCHECK
static XRectangle day_mon_rect[2] = {
	{14, 47, 10, 8},
	{48, 47, 16, 8} };
#endif
