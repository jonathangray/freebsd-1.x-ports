...
#ifdef OW_I18N
	   /*
	    * FIX_ME: Even "response->data" is malloced point, you can
	    * not free the value which offset from malloced point. This
	    * should also apply to the #else part of the code.  This
	    * is workaround for 1102285.  However, should or should
	    * not free the data in the response->data?
	    */
