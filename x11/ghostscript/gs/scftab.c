...
/* scftab.c */
/* Tables for CCITTFax filters (other than run decoding) */
#include "std.h"
#include "scf.h"
...
const cfe_run cf2_run_horizontal = e_(0x1, 3);
...
const cfe_run cf_white_termination[64] = {
...
const cfe_run cf_white_make_up[41] = {
...
const cfe_run cf_black_termination[64] = {
...
const cfe_run cf_black_make_up[41] = {
