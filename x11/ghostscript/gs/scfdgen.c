...
{	FILE *out = fopen("scfdtab.c", "w");
	...
	fputs("/* This file is part of Ghostscript.  It is licensed under the same */\n", out);
	fputs("/* terms as the rest of Ghostscript.  If you do not have Ghostscript, */\n", out);
	fputs("/* you do not have the right to have this file. */\n\n", out);
	fputs("/* scfdtab.c */\n", out);
