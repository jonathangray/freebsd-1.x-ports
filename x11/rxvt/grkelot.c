 ...
 * File:	grkelot.c
 *
 * Synopsis:	string -> greek ELOT928 string; 4-state FSM implementation.
 *
 * System:	Any (ANSI C)
 *
 ...
 *
 * $Header: /a/cvs/386BSD/ports/x11/rxvt/grkelot.c,v 1.1 1994/05/12 11:15:34 jkh Exp $
 */
 ...
 */
static void
kstate_init_all(void)
{
	/* the translation tables for the 4 FSM states for ELOT-928 mappings */
	char xlat_gr[] = 	"65-122:193,194,216,196,197,214,195,199,201,206,202,203,204,205,207,208,81,209,211,212,200,217,87,215,213,198,91,92,93,94,95,96,225,226,248,228,229,246,227,231,233,238,234,235,236,237,239,240,113,241,243,244,232,249,242,247,245,230";
	char xlat_gracc[] = 	"65-122:182,194,216,196,184,214,195,185,186,206,202,203,204,205,188,208,81,209,211,212,200,191,87,215,190,198,91,92,93,94,95,96,220,226,248,228,221,246,227,222,223,238,234,235,236,237,252,240,113,241,243,244,232,254,242,247,253,230";
	char xlat_gruml[] =	"65-122:193,194,216,196,197,214,195,199,218,206,202,203,204,205,207,208,81,209,211,212,200,217,87,215,219,198,91,92,93,94,95,96,225,226,248,228,229,246,227,231,250,238,234,235,236,237,239,240,113,241,243,244,232,249,242,247,251,230";
	char xlat_graum[] =	"65-122:193,194,216,196,197,214,195,199,201,206,202,203,204,205,207,208,81,209,211,212,200,217,87,215,213,198,91,92,93,94,95,96,225,226,248,228,229,246,227,231,192,238,234,235,236,237,239,240,113,241,243,244,232,249,242,247,224,230";
	int i;
	...
	kstate_setcurr(0);
	kstate_add_xlat(xlat_gr);
	kstate_add_switcher("A;:1");
	kstate_add_switcher("A::2");
	kstate_set_life("L0");

	kstate_setcurr(1);
	kstate_add_xlat(xlat_gracc);
	kstate_add_switcher("A::3");
	kstate_set_life("L1");

	kstate_setcurr(2);
	kstate_add_xlat(xlat_gruml);
	kstate_add_switcher("A;:3");
	kstate_set_life("L1");

	kstate_setcurr(3);
	kstate_add_xlat(xlat_graum);
	kstate_set_life("L1");
}
...
/* --- New code: interface with the greek rxvt --- */
