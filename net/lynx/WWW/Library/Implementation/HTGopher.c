        ...
        HTParentAnchor *,anAnchor)
{
    ...
    PUTS(" Press the 's' key and enter keywords to search for.\n"); 
    PUTS(" The keywords that you enter will allow you to search on a\n");
...
*/      
  ...
  if (status<0){
    ...
    HTProgress ("Sending Gopher request.");
    ...
    HTProgress ("Gopher request sent; waiting for response.");
