...
#ifndef lint
static char rcsid[] = "$Header: /a/cvs/386BSD/ports/net/tcl-dp/main.c,v 1.1 1993/09/01 00:46:27 jkh Exp $ SPRITE (Berkeley)";
#endif
...
/* 
 * Extended Tcl and Tcl-DP: 
 *
 * If you are using Extended Tcl from NeoSoft,
 * uncomment the following line of "#define TK_EXTENDED",
 *
 */
...
#ifdef TK_EXTENDED
	Tk_CreateFileHandler(0, stdin, TK_READABLE, StdinProc, (ClientData) 0);
#else
