/* $Header: /a/cvs/386BSD/ports/shell/tcsh/vms.termcap.c,v 1.1.1.2 1994/07/05 20:39:56 ache Exp $ */
/*
 ...
 */
#include "sh.h"
RCSID("$Id: vms.termcap.c,v 1.1.1.2 1994/07/05 20:39:56 ache Exp $")
#ifdef _VMS_POSIX
/*    efth      1988-Apr-29
