#	$Header: /a/cvs/386BSD/ports/comm/flexfax/port/sgi/defs.cc,v 1.1 1993/08/31 23:47:21 ljo Exp $
#
...
GCDEFS=
GCINCS=-I${PORT} -I${GENERIC} -I${UTIL} -I${TIFF}
#
...
GC++OPTS=+a1 +w +p -v2 -float ${OPTIMIZER}
GC++INCS=-I${PORT} -I${GENERIC} -I${UTIL} -I${IV} -I${TIFF} \
