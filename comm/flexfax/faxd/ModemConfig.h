/*	$Header: /a/cvs/386BSD/ports/comm/flexfax/faxd/ModemConfig.h,v 1.1 1993/08/31 23:42:47 ljo Exp $
/*
...
struct ModemConfig {
    ...
    fxStr	hayesQueryCmd;		// cmd for doing Hayes ATI4-style query
    ...
    BaudRate	recvRate[4];		// receive rate to force
    ...
    void parseItem(const char* tag, const char* value);
