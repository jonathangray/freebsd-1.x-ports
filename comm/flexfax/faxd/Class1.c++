/*	$Header: /a/cvs/386BSD/ports/comm/flexfax/faxd/Class1.c++,v 1.1 1993/08/31 23:41:58 ljo Exp $
/*
...
{
    if (FaxModem::atResponse(buf, ms) == AT_OTHER && streq(buf, "+FCERROR", 8))
