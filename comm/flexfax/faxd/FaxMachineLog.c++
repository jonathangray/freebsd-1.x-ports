/*	$Header: /a/cvs/386BSD/ports/comm/flexfax/faxd/FaxMachineLog.c++,v 1.1 1993/08/31 23:42:17 ljo Exp $
/*
...
FaxMachineLog::FaxMachineLog(const fxStr& number)
{
    fxStr canon(number);
...
#ifdef __GNUC__
extern "C" char* strerror(int);		// XXX should be in <string.h>
#endif
...
FaxMachineLog::vlog(const char* fmt0, va_list ap)
{
   if (fd == -1)
    ...
    strftime(buf, sizeof (buf), "%h %e %T", localtime(&tv.tv_sec));
