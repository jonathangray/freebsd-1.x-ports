/*	$Header: /a/cvs/386BSD/ports/comm/flexfax/faxd/Everex.c++,v 1.1 1993/08/31 23:42:11 ljo Exp $
/*
...
{
    if (!lockBaudRate(EVEREX_CMDBRATE, FLOW_XONXOFF, FLOW_XONXOFF) || !reset())
	return (FALSE);
    type = UNKNOWN;
...
{
    return (getModemLine(buf, ms) > 2 && streq(buf, "R ", 2));
}
