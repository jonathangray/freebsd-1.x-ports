/*	$Header: /a/cvs/386BSD/ports/comm/flexfax/faxd/Class1Recv.c++,v 1.1 1993/08/31 23:42:01 ljo Exp $
/*
...
Class1Modem::findAnswer(const char* s)
{
    ...
    return streq(s, answer.msg, answer.len) ? &answer : FaxModem::findAnswer(s);
}
