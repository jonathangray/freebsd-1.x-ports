/*	$Header: /a/cvs/386BSD/ports/comm/flexfax/faxd/FaxRecv.c++,v 1.1 1993/08/31 23:42:23 ljo Exp $
/*
...
FaxServer::recvSetupPage(TIFF* tif, long group3opts, int fillOrder)
{
    ...
    TIFFSetField(tif, TIFFTAG_SOFTWARE,		"FlexFAX Version 2.1");
