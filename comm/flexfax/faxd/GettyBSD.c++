/*	$Header: /a/cvs/386BSD/ports/comm/flexfax/faxd/GettyBSD.c++,v 1.1 1993/08/31 23:42:39 ljo Exp $
/*
...
BSDGetty::BSDGetty(const fxStr& l, const fxStr& s, u_int t, fxBool nl)
    : Getty(l,s,t,nl)
{
}
