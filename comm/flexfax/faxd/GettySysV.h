/*	$Header: /a/cvs/386BSD/ports/comm/flexfax/faxd/GettySysV.h,v 1.1 1993/08/31 23:42:41 ljo Exp $
/*
...
public:
    SysVGetty(const fxStr& dev, const fxStr& speed,
	u_int timeout = 60, fxBool nolog = TRUE);
    ~SysVGetty();
