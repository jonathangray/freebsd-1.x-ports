#ifndef lint
static char rcsid[] = "$Header: /a/cvs/386BSD/ports/comm/flexfax/libtiff/tif_write.c,v 1.1 1993/08/31 23:45:25 ljo Exp $";
#endif
...
static	int TIFFAppendToStrip(TIFF *, u_long, u_char *, u_long);
...
DECLARE4(TIFFWriteScanline,
	TIFF*, tif, u_char*, buf, u_long, row, u_int, sample)
{
...
DECLARE4(TIFFWriteEncodedStrip,
	TIFF*, tif, u_long, strip, u_char*, data, u_long, cc)
{
 ...
 */
static int
DECLARE4(TIFFAppendToStrip, TIFF*, tif, u_long, strip, u_char*, data, u_long, cc)
{
	TIFFDirectory *td = &tif->tif_dir;
