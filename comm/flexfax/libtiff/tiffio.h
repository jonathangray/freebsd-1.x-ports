/* $Header: /a/cvs/386BSD/ports/comm/flexfax/libtiff/tiffio.h,v 1.1 1993/08/31 23:45:29 ljo Exp $ */
...
typedef	long (*TIFFReadWriteProc)(void*, char*, unsigned long);
...
extern	int TIFFReadScanline(TIFF*, unsigned char*, unsigned long, unsigned = 0);
extern	int TIFFWriteScanline(TIFF*, unsigned char*, unsigned long, unsigned = 0);
extern	int TIFFReadRGBAImage(TIFF*,
	    unsigned long, unsigned long, unsigned long*, int stop = 0);
#else
extern	void TIFFPrintDirectory(TIFF*, FILE*, long);
extern	int TIFFReadScanline(TIFF*, unsigned char*, unsigned long, unsigned);
extern	int TIFFWriteScanline(TIFF*, unsigned char*, unsigned long, unsigned);
extern	int TIFFReadRGBAImage(TIFF*,
...
extern	int TIFFWriteTile(TIFF*,
	    ...
	    unsigned long, unsigned long, unsigned long,
	    unsigned int);
extern	unsigned long TIFFComputeStrip(TIFF*, unsigned long, unsigned int);
extern	unsigned long TIFFNumberOfStrips(TIFF*);
extern	long TIFFReadEncodedStrip(TIFF*, unsigned long, unsigned char*, unsigned long);
extern	long TIFFReadRawStrip(TIFF*, unsigned long, unsigned char*, unsigned long);
...
extern	long TIFFWriteEncodedStrip(TIFF*, unsigned long, unsigned char*, unsigned long);
extern	long TIFFWriteRawStrip(TIFF*, unsigned long, unsigned char*, unsigned long);
...
extern	long TIFFReadTile();
extern	int TIFFWriteTile();
extern	unsigned long TIFFComputeStrip();
extern	unsigned long TIFFNumberOfStrips();
extern	long TIFFReadEncodedStrip();
extern	long TIFFReadRawStrip();
extern	long TIFFReadEncodedTile();
extern	long TIFFReadRGBAImage();
