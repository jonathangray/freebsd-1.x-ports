#ifndef lint
static char rcsid[] = "$Header: /a/cvs/386BSD/ports/comm/flexfax/libtiff/tif_read.c,v 1.1 1993/08/31 23:45:13 ljo Exp $";
#endif
...
#if USE_PROTOTYPES
static	int TIFFFillStrip(TIFF *, u_long);
static	int TIFFFillTile(TIFF *, u_int);
static	int TIFFStartStrip(TIFF *, u_long);
 ...
 */
static int
DECLARE3(TIFFSeek, TIFF*, tif, u_long, row, u_int, sample)
{
...
int
/*VARARGS3*/
DECLARE4(TIFFReadScanline, TIFF*, tif, u_char*, buf, u_long, row, u_int, sample)
{
	int e;
...
DECLARE4(TIFFReadEncodedStrip,
    TIFF*, tif, u_long, strip, u_char*, buf, u_long, size)
{
...
DECLARE5(TIFFReadRawStrip1,
    TIFF*, tif, u_long, strip, u_char*, buf, u_long, size, const char*, module)
{
	TIFFDirectory *td = &tif->tif_dir;
 ...
 */
static int
DECLARE2(TIFFFillStrip, TIFF*, tif, u_long, strip)
{
 ...
 */
static int
DECLARE2(TIFFStartStrip, TIFF*, tif, u_long, strip)
{
	TIFFDirectory *td = &tif->tif_dir;
