/*	$Header: /a/cvs/386BSD/ports/comm/flexfax/recvfax/submit.c,v 1.1 1993/08/31 23:49:01 ljo Exp $
/*
...
static	u_long cvtTime(const char* spec, struct tm* now, const char* what);
